													 ...
													 options.contextDetails = {
													  ...
													  let realizedViewOption = {
														...
														ChgIDCardCommonServices.getUserAccess(physicalID).then(function(resp){
															...
															caModel['name'] = options.contextDetails.name;
															caModel['title'] = options.title;
															caModel['description'] = options.contextDetails.description;
															caModel['severity'] = options.contextDetails.severity;
															caModel['maturity'] = options.contextDetails.maturity;
															caModel['invokedFrom'] = 'gov';
															caModel['get'] = function (attributeName) {
															  if ('userAccess' == attributeName) {
																return resp.userAccess;
															  } else if ('id' == attributeName) {
																return caModel.id;
															  }
															  else if ('synopsis' === attributeName) {
																return options.title;
															  }
															};
															
															caModel['fetch'] = function (options) {
															  console.log('dummy fetch called...!');
															  options.onComplete();
															};
