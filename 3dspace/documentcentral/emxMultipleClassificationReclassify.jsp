...
<%@page import="com.matrixone.apps.classification.ClassificationConstants"%>
...
<%
    ...
    String strObjectId          =  (String)session.getAttribute("classifiedObjectIds");
                    ...
                    if(strAttributeGroupName != null)
                    {
                        ...
                        if(listAttributes != null){
                            ...
                            if(iAttrSize > 0){
								...
								if(!(agNameForMessage).startsWith("Generated") && (agNameForMessage).endsWith(ClassificationConstants.ATTRIBUTE_GROUP_NAME_SUFFIX)){
									agNameForMessage = agNameForMessage.substring(0, agNameForMessage.length() - ClassificationConstants.ATTRIBUTE_GROUP_NAME_SUFFIX.length());
								}
                            }
