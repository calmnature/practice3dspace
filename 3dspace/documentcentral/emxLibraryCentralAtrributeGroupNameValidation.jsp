...
<% 
	...
	attributeGroupName = attributeGroupName +ClassificationConstants.ATTRIBUTE_GROUP_NAME_SUFFIX;
    AttributeGroup attrGrp      = AttributeGroup.getInstance(context,attributeGroupName);
    String isAGNameExists       = "false";
    if ("ClassificationAttributes".equalsIgnoreCase(attributeGroupName) || !UIUtil.isNullOrEmpty(attrGrp.getName())) {
        isAGNameExists          = "true";
    }
    out.clear();
