...
<%
	...
	AttributeGroup attributeGroup = AttributeGroup.getInstance(context, parentId);

	attributeGroup.setName(parentId);
	attributeGroup.addAttributes(context,slAttrList);
%>
