...
<%
            ...
            list.add(ProgramCentralConstants.SELECT_IS_CHECKLIST);
            list.add(ProgramCentralConstants.SELECT_IS_CHECKLIST_ITEM);
            ...
            String isChecklist = objectInfo.get(ProgramCentralConstants.SELECT_IS_CHECKLIST);
            String isChecklistItem = objectInfo.get(ProgramCentralConstants.SELECT_IS_CHECKLIST_ITEM);
			...
			boolean isOpportunity = "true".equalsIgnoreCase((String)objectInfo.get(ProgramCentralConstants.SELECT_IS_OPPORTUNITY));
			 boolean isRootFolderOrTask = "true".equalsIgnoreCase(isFolderType) 
	            		|| "true".equalsIgnoreCase(isTaskType) 
	            		|| Assessment.TYPE_ASSESSMENT.equalsIgnoreCase(selectedObjectType) 
	            		|| isRisk || isOpportunity 
	            		|| DomainConstants.TYPE_BUSINESS_GOAL.equalsIgnoreCase(selectedObjectType) 
	            		|| ((DomainConstants.TYPE_PROJECT_SPACE.equalsIgnoreCase(selectedObjectType) 
	            				|| DomainObject.TYPE_PROJECT_TEMPLATE.equalsIgnoreCase(selectedObjectType) 
	            				|| DomainConstants.TYPE_PROJECT_CONCEPT.equalsIgnoreCase(selectedObjectType) 
	            				|| "true".equalsIgnoreCase(isChecklist)
	            				|| "true".equalsIgnoreCase(isChecklistItem)) && "referenceDocument".equalsIgnoreCase(mode)); 
      boolean isCallFromProjectTypes = "TRUE".equalsIgnoreCase(isTaskType) || (("TRUE".equalsIgnoreCase(isProjectTemplate) || "TRUE".equalsIgnoreCase(isProjectConcept) || "TRUE".equalsIgnoreCase(isProjectSpace)) && "referenceDocument".equalsIgnoreCase(mode));
        	...
        	//Added 29-June-2010:rg6:IR-054194
            	if(emxTableRowId != null && emxTableRowId.length > 0) {   //End 29-June-2010:rg6:IR-054194     
            		...
            		String strLanguage = context.getSession().getLanguage();
            		 Map map =request.getParameterMap();
            		    ...
            		    if(selctedObjList != null) {
            		        if(selctedObjList.length > 1 && !isCallFromProjectTypes){
            	 ...
            	 for(int k=0; k<emxTableRowId.length; k++)
            	 {
            		 ...
            		 if(isCallFromProjectTypes){
						 folderId = objectId;
					 }
            		 if(ProgramCentralUtil.isNotNullString(folderId) && !(isCallFromProjectTypes)){
            			 ...
            			 String strControlledFolderCurrState = dObj.getInfo(context,DomainConstants.SELECT_CURRENT);
            			 if(ProgramCentralConstants.STATE_CONTROLLED_FOLDER_REVIEW.equalsIgnoreCase(strControlledFolderCurrState) || ProgramCentralConstants.STATE_CONTROLLED_FOLDER_COMPLETE.equalsIgnoreCase(strControlledFolderCurrState)){
            				// if controlled folder is in review (frozen) state can't perform create new document 
     ...
     <%
         ...
         //Added 29-June-2010:rg6:IR-054295   
          ...
          //End 29-June-2010:rg6:IR-054295
            ...
            if(ProgramCentralConstants.TYPE_QUALITY.equalsIgnoreCase(selectedObjectType)||"true".equalsIgnoreCase(isParentKindOFProjectTemplate) || "Assessment".equalsIgnoreCase((String)objectInfo.get(DomainConstants.SELECT_TYPE)) || DomainConstants.TYPE_BUSINESS_GOAL.equalsIgnoreCase(selectedObjectType) || isRisk || isOpportunity){
            	session.setAttribute("needFullPageRefresh", "true");
            }
            if("TRUE".equalsIgnoreCase(isTaskType) || (("TRUE".equalsIgnoreCase(isProjectTemplate) || "TRUE".equalsIgnoreCase(isProjectConcept) || "TRUE".equalsIgnoreCase(isProjectSpace) || "true".equalsIgnoreCase(isChecklist) ||  "true".equalsIgnoreCase(isChecklistItem)) && "referenceDocument".equalsIgnoreCase(mode))){
				 session.setAttribute("needFullPageRefresh", "true");
	         }
