define('DS/MePreferencesClientAPI/MePreferencesClientAPI',
    ...
    function (MePreferencesPlatformServicesUtils, PlatformAPI) {
        ...
        var mePrefPublicAPI = {
           ...
           */
            readPreferences: function (rawInputArray) {
                ...
                if(window.ds!= null && window.ds.anonymous == true){
                    return Promise.reject("\n\t Anonymous user cannot readPreferences");
                }
            ...
            */
            getMePreferencesDialog: async function (appID, data) {
                try {
                    const MePreferencesModalDialog = await new Promise((resolve, reject) => {
                        require(['DS/MePreferencesUIElements/MePreferencesModalDialog'], resolve, reject);
                    });
                    const MePreferencesCustomViewBuilder = await new Promise((resolve, reject) => {
                        require(['DS/MePreferencesUIBuilder/MePreferencesCustomViewBuilder'], resolve, reject);
                    });
                    ...
                    if (appID == null || (data && data.startBuildDlg === true)) {
                        ...
                        mePreferencesModalDialog = await MePreferencesModalDialog.getMePreferenceDialog(appID, data);
                        return mePreferencesModalDialog;
                    } else {
                        //Retrieve Tenant ID:
                        var tenantID = await MePreferencesPlatformServicesUtils.getTenant();
