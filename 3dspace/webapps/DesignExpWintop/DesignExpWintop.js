        ...
        init: function (options) {
            ...
            require(['DS/DesignEnvironmentUX/DesignEnvCore'
                ...
                function (DesignEnvCore, DesignEnvListView, GlobalUtils) {
                    ...
                    that.designExpPanel.addCommandHit = (probeName)=>{ // Probe for WIW interactions
                        require(['DS/PADServices/utils/PADTrackerManager'], function (PADTrackerManager) {
                            PADTrackerManager.addCommandHit(probeName);
                        });
                    }
                    that.designExpPanel.addCommandHit('DGX-InitializeDEWiWOption');
