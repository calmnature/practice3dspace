                ...
                if (typeof w.uwaUrl === 'string') {
                    try {
                        ...
                        if (hypervisorLocal != null) {
                            ...
                            resolve(connection);
                            //reject(new Error("PXPBackend- hypervisorLocal is null && tenant is not 'onPremise' "));
                        }
                    }
                    catch (error) {
                        ...
                        reject(new Error("PXPBackend- UWA URL is invalid ! (" + error + ")"));
                    }
                }
            }
            else {
