...
define("DS/WebVisuXRToolkitNativeSkills/WebVisuXRToolkitControllerFlyNav", ["require", "exports", "DS/Visualization/ThreeJS_DS", "DS/WebappsUtils/WebappsUtils", "DS/WebVisuXRToolkit/WebVisuXRToolkit", "i18n!DS/WebVisuXRToolkit/assets/nls/WebVisuXRToolkitNativeSkills"], function (require, exports, THREE, WebappsUtils_1, WebVisuXRToolkit_1, NLS) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ControllerFlyNav = exports.FlySpeedSlider = exports.flyNavUI = void 0;
    exports.flyNavUI = new WebVisuXRToolkit_1.HandMenuUIComponents();
    exports.FlySpeedSlider = new WebVisuXRToolkit_1.Slider("FlySpeed", 1000, 1, 1, 50, "mm/s");
    const container = new WebVisuXRToolkit_1.Container("default", "row");
    container.addElement(exports.FlySpeedSlider);
    exports.flyNavUI.insertAtRow(0, container);
    class ControllerFlyNav extends EventTarget {
        ...
        onActivate(input) {
            ...
            if (input.targetRayWorldMatrix) {
                const speed = exports.FlySpeedSlider.value;
                ...
                /*if (skillInfo.UIComponents!.getElementValue("_followControllerOrientation")!)
                {
                    input.targetRayWorldMatrix.decompose(undefined, raycastOrientation, undefined);
                }
                else
                {*/
                const raycastOrientation = (0, WebVisuXRToolkit_1.getHeadWorldMatrix)().decompose()[1];
                //}
                const controllerOrientation = input.targetRayWorldMatrix.decompose()[1];
                ...
                if (joystickX !== 0 || joystickY !== 0) {
                    ...
                    if (absX > absY) { // Strafe left/right has higher magnitude
                        ...
                        const isControllerAimingUp = new THREE.Vector3(0, 1, 0).applyQuaternion(controllerOrientation).dot(new THREE.Vector3(0, 0, 1)) > 0.65;
                        if (isControllerAimingUp) {
                            raycastForward = new THREE.Vector3(0, 0, joystickY < 0 ? -1 : 1).applyQuaternion(raycastOrientation).normalize();
                        }
                        else {
