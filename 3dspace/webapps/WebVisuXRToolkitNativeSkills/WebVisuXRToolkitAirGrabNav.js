...
define("DS/WebVisuXRToolkitNativeSkills/WebVisuXRToolkitAirGrabNav", ["require", "exports", "DS/Visualization/ThreeJS_DS", "DS/WebVisuXRToolkit/WebVisuXRToolkit", "i18n!DS/WebVisuXRToolkit/assets/nls/WebVisuXRToolkitNativeSkills"], function (require, exports, THREE, WebVisuXRToolkit_1, NLS) {
    "use strict";
    ...
    class ControllerAirGrab extends EventTarget {
        ...
        twoControllersMovement() {
            ...
            /*const skillInfo = WebVisuXRToolkitConfigManager.instance.getSkillInfos("Air Grab Navigation")!
    
            if (skillInfo.UIComponents!.getElementValue("_EnableAirGrabScaling"))
            {
                ...
                const headData = getHeadMatrix().decompose();
                ...
                diffPos.add(new THREE.Vector3(0, 0, headData[0].z).multiplyScalar(initScale - scale).applyQuaternion(getXRNode().getMatrix().decompose()[1]))
                getXRNode().setMatrix(this.computeMovementAndRotation(quat, diffPos, initXRNodeMatrixData[0], curBariPos, new THREE.Vector3(scale, scale, scale)))
            }
            else
            {*/
        ...
        oneControllerMovement(input) {
            ...
            //const skillInfo = WebVisuXRToolkitConfigManager.instance.getSkillInfos("Air Grab Navigation")!
            /*if (skillInfo.UIComponents!.getElementValue("_EnableAirGrabMonoInputRotation"))
            {
        ...
        onUnregisterInput(input) {
            if (input.handedness !== WebVisuXRToolkit_1.InputHandedness.None) {
