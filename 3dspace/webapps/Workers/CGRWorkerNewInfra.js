        ...
        workerContext.onmessage = function(e) {
            ...
            var onCGRLoaded = function(mesh, target) {
                ...
                workerContext.postMessage({
                    ...
                    sgRep: mesh.sgRep,
                    primitivesByRep: mesh.primitivesByRep,
                    hlMap: (mesh.hlMap && (mesh.hlMap.size >0)) ?mesh.hlMap:null,
            ...
            options = {
                ACADInheritance: data.ACADInheritance ? data.ACADInheritance : false,
                ...
                expandMode: data.isExpandMode ? data.isExpandMode : false,
                ...
                WebGPU: data.WebGPU,
                WebGLVersion: data.WebGLVersion,
            }
