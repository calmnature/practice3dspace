...
define("DS/DELSwimLaneChart_v2/model/SwimLaneChartNode", ["require", "exports", "DS/DELSwimLaneChart_v2/utils/StaticAttributes", "DS/DELSwimLaneChart_v2/utils/TextUtils"], function (require, exports, StaticAttributes_1, TextUtils_1) {
    ...
    class SwimLaneChartNode {
        constructor(id, parentId, position, width = StaticAttributes_1.swimLanechartNodeHeight, height = StaticAttributes_1.swimLanechartNodeHeight, header = null, content = {}, isCollapsible = true, isCollapsed = false, isPinnable = false) {
            var _a;
            this._type = "Node";
            ...
            this._isCollapsed = header ? isCollapsed : false;
        ...
        findStr(str) {
            ...
            const locations = [];
            let count = 0;
            if (!this._isHidden && this.header && this.header.childElement) {
                const occurencesNb = (0, TextUtils_1.findAllOccurrences)((_b = (_a = this.header.childElement.textContent) === null || _a === void 0 ? void 0 : _a.replace(/<\/?mark>/gi, '')) !== null && _b !== void 0 ? _b : "", str);
                if (occurencesNb > 0) {
                    locations.push("Header");
                    count += occurencesNb;
                }
            }
            else if (!this._isHidden && this.header && this.header.text) {
            ...
            if (!this._isHidden && !this.isMinimized && !this.isCollapsed && this.content.childElement) {
                const occurencesNb = (0, TextUtils_1.findAllOccurrences)((_d = (_c = this.content.childElement.textContent) === null || _c === void 0 ? void 0 : _c.replace(/<\/?mark>/gi, '')) !== null && _d !== void 0 ? _d : "", str);
                if (occurencesNb > 0) {
                ...
                const occurencesNb = (0, TextUtils_1.findAllOccurrences)((_e = this.content.text) === null || _e === void 0 ? void 0 : _e.replace(/<\/?mark>/gi, ''), str);
                if (occurencesNb > 0) {
                    locations.push("Content");
                    count += occurencesNb;
                }
