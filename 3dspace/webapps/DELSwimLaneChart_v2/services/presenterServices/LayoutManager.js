        ...
        updateModelWidth() {
            ...
            this._swimLaneChartModel.nodes.forEach((v) => {
                ...
                if (parent) {
                    ...
                    if (v.node.height === 0 || (((_a = v.node.header) === null || _a === void 0 ? void 0 : _a.textWrap) === "wrap" || ((_b = v.node.header) === null || _b === void 0 ? void 0 : _b.textWrap) === "nowrap")) {
                        if (v.node.type === "CompositeNode") {
                            ...
                            if (((_c = v.node.header) === null || _c === void 0 ? void 0 : _c.textWrap) === "wrap")
                ...
                if (col) {
                    ...
                    if (v.node.height === 0 || ((_d = v.node.header) === null || _d === void 0 ? void 0 : _d.textWrap) === "wrap" || ((_e = v.node.header) === null || _e === void 0 ? void 0 : _e.textWrap) === "nowrap") {
                        if (v.node.type === "CompositeNode") {
                            v.node.height = this._swimLaneChartModel.computeNodeHeightFromHtmlContent(v.node, v.node.width);
                            v.node.bodyHeight = v.node.height;
                            if (((_f = v.node.header) === null || _f === void 0 ? void 0 : _f.textWrap) === "wrap")
                                this.placeChildElements(v);
                        }
                        else {
                            v.node.height = this._swimLaneChartModel.computeNodeHeightFromHtmlContent(v.node, v.node.width);
                    ...
                    if (parentChildCondition) {
                        if (!visitedNodesIds.includes(currentNodeId)) {
                            if (!currentElt.node.parentId && currentElt.nodeisParentOfInnerGroupElt && currentElt.nodeisParentOfInnerGroupElt.length > 0) {
                                ...
                                this.setVerticalPositionOfGroupElt(currentElt, startY + StaticAttributes_1.groupMargin);
                                // this.setVerticalPositionOfGroupElt(currentElt, maxOffset === 0 ? startY + groupMargin : maxOffset + groupMargin);
                            }
                            else {
