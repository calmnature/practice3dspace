...
define("DS/DELSwimLaneChart_v2/utils/TextUtils", ["require", "exports", "DS/DELSwimLaneChart_v2/utils/StaticAttributes"], function (require, exports, StaticAttributes_1) {
    "use strict";
    ...
    const computeHtmlContentHeight = (htmlContent, width) => {
        ...
        const nodeHeight = ((_a = div.firstChild) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect().height) || div.offsetHeight;
        div.removeChild(htmlContent);
        document.body.removeChild(div);
        // Sandbox container to simulate layout
        const sandbox = document.querySelector(".pxpsandboxcontainer");
        // Clone element so we don’t disturb the original
        const clone = htmlContent.cloneNode(true);
        clone.style.cssText = `
        width: ${width}px !important;
      `;
        // add to SwimLaneDom
        sandbox === null || sandbox === void 0 ? void 0 : sandbox.appendChild(clone);
        ...
        // Cleanup
        sandbox === null || sandbox === void 0 ? void 0 : sandbox.removeChild(clone);
        return Math.max(nodeHeight, rect.height + marginTop + marginBottom, StaticAttributes_1.gridStep);
    };
