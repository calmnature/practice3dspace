...
define("DS/StudioUIActorModelWeb/extensions/CATE3DImageButton3DGeoVisu", [
  ...
  let CATE3DImageButton3DGeoVisu = CATE3DActor3DGeoVisu.extend(
    Listener,
    /** @lends DS/StudioUIActorModelWeb/extensions/CATE3DImageButton3DGeoVisu.prototype **/
    {
      ...
      _refreshProperties: async function () {
        ...
        for (let index in imageNames) {
          ...
          if (normalImageObject) {
            let textureAsset = normalImageObject.QueryInterface(
      ...
      _redrawButton: function () {
        if (this._buttonNode) {
          ...
          this._buttonNode.canvasNodeTexture.maxPow = this.computePow();
          this.RequestVisuRefresh();
        }
      ...
      _updateDisplayState: function () {
        ...
        this._displayState = this._isEnabled
          ? this._isPressed
            ? "pressed"
            : this._isHovered
              ? "hovered"
          ...
          : "disabled";
        const imageId =
          (this._displayState === "enabled" ? "normal" : this._displayState) +
          "Image";
        const imageTexture = this._images[imageId];
        this._textureImage = imageTexture?.img;
        this._textureSize = imageTexture?.dim;
      },
          ...
          this.listenTo(
            ...
            function () {
              if (!_this._isPressed) {
                ...
                _this.frameVisuChanges.push(_this._redrawButton);
