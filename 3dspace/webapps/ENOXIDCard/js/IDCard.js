      ...
      //************** if target is a attribute-section
        ...
        */
        ...
        //     }
            ...
            let widthFreeZone0 = parseInt(getComputedStyle(that.container.getElement('.free-zone-0')).width); 
            let widthFreeZone1 = parseInt(getComputedStyle(that.container.getElement('.free-zone-1')).width); 
            let marginFreeZone0 = parseInt(getComputedStyle(that.container.getElement('.free-zone-0'))["margin-left"]); 
            let marginFreeZone1 = parseInt(getComputedStyle(that.container.getElement('.free-zone-1'))["margin-left"]); 

            var limitFreeZone0= attributePlaceholderWidth+widthFreeZone0 + marginFreeZone0 + 5 ; // free zone width + margin left + 5 just in case
            var limitFreeZone1= attributePlaceholderWidth+widthFreeZone0 + widthFreeZone1 + marginFreeZone1 + 5 ;
