...
import * as platformkitConfig from '@ds/platformkit/stores';
import * as swymkitConfig from '@ds/swymkit/stores';
...
function getPlatformId() {
  try {
    return platformkitConfig.getPlatformId();
  } catch (error) {
    return swymkitConfig.getPlatformId();
  }
}

function getRegistryUrl() {
  try {
    return platformkitConfig.getRegistryUrl();
  } catch (error) {
    return swymkitConfig.getRegistryUrl();
  }
}
