...
function toggleComponent() {
  if (selectedComponent.value == 'History') selectedComponent.value = 'Preferences';
  else selectedComponent.value = 'History';
}
...
<template>
  <div class="main-container" @clearHistory="clearHistory">
    <div class="leftPanel">
      <call-starter searchedValue="" @startConversation="sendMsg" />
    </div>
