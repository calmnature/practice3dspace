	...
	function (STU, Task, Camera, XRManager, Event, EventServices) {
        ...
        */
		...
		XRHeadsetActor.prototype.onExecute = function (iExeCtx) {
			...
			if (XRHeadsetTransform !== null & XRHeadsetTransform !== undefined) {
		...
		XRHeadsetActor.prototype.isWorn = function () {
			//Old fashined way to retrive the info, but since EPDevice is not updataing their code anymore...
			/*
