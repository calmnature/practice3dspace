                    ...
                    if (i % 2 == 0) {
                        ...
                        columns[i]["getCellClassName"] = function (cellInfos) {
                            if (cellInfos.nodeModel) {
                                ...
                                var className = "data-me-preferences-dgv-po-lock-class-" + appID + "." + repoName + "." + prefName;
                                return className;
                            }
                        };
                        ...
                        columns[i]["setCellValue"] = function (cellInfos, value) {
                            if (cellInfos.nodeModel) {
                                ...
                                let identifier = cellInfos.nodeModel._options.appID + "." + cellInfos.nodeModel.getAttributeValue("column" + (cellInfos.columnID + 1) + "repository") + "." + cellInfos.nodeModel.getAttributeValue("column" + (cellInfos.columnID + 1) + "Name") + ".lock";
