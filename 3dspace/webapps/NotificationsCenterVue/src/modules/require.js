import { DS_WEBAPPS_URL_IFRAME as DS_WEBAPPS_URL } from '~/modules/globalVars';

const AMDLOADER_SCRIPT = 'AmdLoader/AmdLoader.js';
let initAsync;

async function setupGlobalEnvVar() {
...
async function requirejs(modules) {
  if (!initAsync)
