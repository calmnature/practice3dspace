...
import { getServices, getSettings, getTenantAgnosticMode, getTenants, resetBadge } from '~/api/senders';
...
async function setUp() {
  ...
  await Promise.all([getServices(), getSettings(), getTenants(), getTenantAgnosticMode(), translationsPromiseSetup]);
}
