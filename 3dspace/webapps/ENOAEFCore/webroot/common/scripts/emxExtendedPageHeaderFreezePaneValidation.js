...
function hideAppMenu() {
	 ...
	 if($('#mydeskpanel').hasClass("appMenu")){
		 $("#mydeskpanel").hide(); 
		 if (!jQuery("div#mydeskpanel").is(':visible') && getTopWindow() && !getTopWindow().getWindowOpener()) {			
...
function toggleExtendedPageHeader(){
	...
	if(offsetTop === 0)
	{
		offsetTop = extpageHeadDiv.offset().top || 0;
	}
