...
/* eslint-disable */
define('DS/JSONLinter/JSONLinter',
    [],
	function () {
	    'use strict';
	    return (function () {
	        var parser = {
	            ...
	            productions_: [0, [3, 1], [5, 1], [7, 1], [9, 1], [9, 1], [12, 2], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1],
                    [13, 1], [15, 2], [15, 3], [20, 3], [19, 1], [19, 3], [16, 2], [16, 3], [25, 1], [25, 3]],
	                ...
	                switch (yystate) {
	                    ...
	                    case 17:
	                        ...
	                        if (typeof $$[$0 - 2][$$[$0][0]] !== 'undefined') {
	                            ...
	                            var errStr = '::' + pos.first_line + '::Parse error on line ' + pos.first_line + ': Duplicate property "' + $$[$0][0] + '"';
	                            yy.lexer.parseError(errStr, {
	                                text: $$[$0][0],
	                                line: pos.first_line,
	                                loc: pos
	                            });
	                ...
	                while (true) {
	                    ...
	                    switch (action[0]) {
	                        ...
	                        case 2:
	                            ...
	                            r = this.performAction(yyval, yytext, yyleng, yylineno, this.yy, action[1], vstack, lstack);
