 ...
 * @quickreview KR5     26:01:07 IR-1483438 : added PADContext.get().getPADTreeDocument undefined check in getSelectorManager method 
        ...
        _initWSCalls: function () {
            ...
            CfgUtility.populate3DSpaceURL().then(function () {
                ...
                CfgUtility.populateSecurityContext().then(function () {
                    ...
                    /* MAND IR-690629-3DEXPERIENCER2019x readConfigSettings service call which was failing with error code 403 can be  removed (during PSE init) as decoupling is by default enabled on 19x. however root cause for this service (getconfigurationSettings for decoupling) failure is still unknown */
