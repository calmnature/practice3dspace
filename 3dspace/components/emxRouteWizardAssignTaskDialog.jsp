...
<%
		   ...
		   Iterator mapItr = maplst.iterator();
			while(mapItr.hasNext()) {
			    ...
			    double clientTZOffset     = (new Double((String)session.getAttribute("timeZone"))).doubleValue();
	...
	<%
        ...
        %>
       	...
       	%>
		            	...
		            	<%
       boolean maintainExactTaskList = "Maintain Exact Task List".equals(sTaskEditSetting);
       boolean extendTaskList = "Extend Task List".equals(sTaskEditSetting);
