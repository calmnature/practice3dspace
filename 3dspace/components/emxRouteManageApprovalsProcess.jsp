...
public static String addStateRoutes(Context context, String strObjectId, String[] strStateNewRoutes, HttpSession session) throws Exception {
    ...
    for (int i = 0; i < strStateNewRoutes.length; i++) {
        ...
        Hashtable contentInfo = (Hashtable)domainObject.getInfo(context,objectSelects);
        ...
        try{
            ...
            if(accessRuleEvaluation){
            	mapRelAttributes.put(DomainObject.ATTRIBUTE_ROUTE_BASE_STATE, strStateNameSymbolic);
            } else {
            	mapRelAttributes.put(DomainObject.ATTRIBUTE_ROUTE_BASE_STATE, "Ad Hoc");
            }
...
public static String createRouteFromTemplate(Context context, String strRouteTemplateId) throws Exception {
	...
	selectList.add(SELECT_ATTRIBUTE_TASKEDIT_SETTING);
	...
	String templateTaskEdits = (String)mapInfo.get( SELECT_ATTRIBUTE_TASKEDIT_SETTING);
	String routeTaskEdits = route.getInfo(context, SELECT_ATTRIBUTE_TASKEDIT_SETTING);
	if (UIUtil.isNotNullAndNotEmpty(templateTaskEdits) && (!routeTaskEdits.equalsIgnoreCase(templateTaskEdits))) {
