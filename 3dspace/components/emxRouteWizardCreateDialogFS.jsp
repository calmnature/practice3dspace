...
<%
	...
	String showmenuinToolbar = XSSUtil.encodeForURL(context,emxGetParameter(request,"showmenuinToolbar"));
...
Hashtable hashRouteWizFirst = new  Hashtable();
 hashRouteWizFirst = (Hashtable)formBean.getElementValue("hashRouteWizFirst");
    ...
    String suiteKey   =  XSSUtil.encodeForURL(context,(String)formBean.getElementValue("suiteKey"));
...
try{
 ...
 // the below string is used to check whether the JTFile is configured or not.
  ...
  contentURL.append(XSSUtil.encodeForURL(context,firstTime));
