...
<%
  ...
  {
	String replyOwner = BaseObject.getInfo(context, BaseObject.SELECT_OWNER); 
	String contextUser = context.getUser(); 
	if(replyOwner.equals(contextUser))
    message.deleteReply(context, BaseObject);
	else {
		String errorMessage=EnoviaResourceBundle.getProperty(context,"emxComponentsStringResource",context.getLocale(),"emxComponents.Common.DeleteErrorMessage");
%>
