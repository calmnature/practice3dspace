...
<%if(filterValue.equalsIgnoreCase("Schema") || filterValue.equalsIgnoreCase("All")){%>
      ...
      <TABLE>
        ...
        <%
		  ...
		  String hiddenList = EnoviaResourceBundle.getProperty(context, "emxFramework.AdvancedHelp.Hidden");
		  String[] hiddenListArr = hiddenList.split(","); 
          if(schemas.size()>0){
            java.util.Set keySet = schemas.keySet();
            Iterator itr = keySet.iterator();
            while(itr.hasNext()){
            String str = (String)itr.next();
			if(!Arrays.asList(hiddenListArr).contains(str)){
