...
String STR_ADOPTESIGNSERVICE = FrameworkUtil.getExpressionValue(context, "ADOPT_ESIG_SERVICE");
...
//User Mail
String STR_CURRENT_USER_EMAIL = PersonUtil.getEmail(context);
String STR_CURRENT_USER_NAME = context.getUser();
...
emxUIConstants.CURRENT_USER_EMAIL = "<%=STR_CURRENT_USER_EMAIL%>";
emxUIConstants.STR_CURRENT_USER_NAME = "<%=STR_CURRENT_USER_NAME%>";
...
emxUIConstants.STR_ADOPTESIGNSERVICE = "<%= STR_ADOPTESIGNSERVICE %>";
