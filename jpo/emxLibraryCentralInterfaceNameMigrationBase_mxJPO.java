...
public class emxLibraryCentralInterfaceNameMigrationBase_mxJPO extends emxCommonMigration_mxJPO
{
    ...
    public void migrateObjects(Context context, StringList objectList) throws Exception
    {
    		...
    		HashMap<String,String> hmInterfaceOldNameNewName = new HashMap<String,String>();
        	...
        	for(int LibOrClassItr = 0; LibOrClassItr < lengthObjectList; LibOrClassItr++)
        	{
        		...
        		{ 
					...
					DomainObject objectUnderProcess 	= DomainObject.newInstance(context, objectId_ObjectUnderProcess);
        			...
        			if(UIUtil.isNullOrEmpty(objectUnderProcessInterfaceName)){
						...
						if(!objectUnderProcessInterfaceName.equals(objectUnderProcessPhysicalId))
						{
							if(UIUtil.isNullOrEmpty(hmInterfaceOldNameNewName.get(objectUnderProcessInterfaceName))) {//added if condition for IR-1353938-3DEXPERIENCER2026x
								hmInterfaceOldNameNewName.put(objectUnderProcessInterfaceName, objectUnderProcessPhysicalId);
