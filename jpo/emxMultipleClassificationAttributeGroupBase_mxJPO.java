...
public class emxMultipleClassificationAttributeGroupBase_mxJPO implements ClassificationConstants {
    ...
    throws Exception {
        ...
        try {
            ...
            //for legacy AG , where there is no property title , will through error. So need to catch and format the query without property title.
            if (attrGrpName != null && !"null".equals(attrGrpName)) {
            	try {
                    strQuery    = "list interface $1 select name $2 description originated attribute dump $3";
                    result      = MqlUtil.mqlCommand(context, strQuery, attrGrpName,"property[title].value","|");
            	}catch (Exception e) {
                    ...
                    if (result != null) {
                        ...
                        if (tokens.hasMoreTokens()) {
                            attrGrp.setTitle(tokens.nextToken());
                        }
                        if (tokens.hasMoreTokens()) {
    ...
    public void create(Context context, String[] args) throws Exception {
        try {
            ...
            create(context, name, title, description, attributes, "true".equalsIgnoreCase(isHidden));
        } catch (Exception ex) {
            throw ex;
        }
    }
     ...
     * @throws exception if the operation fails
     */
      public void create(Context context, String name, String title, String description,
        ...
        try {
            ...
            StringBuffer queryBuffer = new StringBuffer("add interface $1 derived $2  add property title value $3 description $4 ");
            ...
            String[] methodArgs = new String[attributes.size()+4];
            methodArgs[0]       = name;
            methodArgs[1]       = DomainConstants.INTERFACE_CLASSIFICATION_ATTRIBUTE_GROUPS;
            methodArgs[2]       = title;
            methodArgs[3]       = description;

            for (int i = 0; i < attributes.size(); i++) {
                queryBuffer.append("attribute ");
                queryBuffer.append("$").append(i+5).append(" ");
                methodArgs[i+4] = (String) attributes.get(i);
            }
    ...
    public void delete(Context context, String name) throws Exception {
        ...
        try {
            _LOG.info("Reloading Tenant Cache after deleting classification attributes group from webapp");
    ...
    public void clone(Context context, String name, String cloneName,
        ...
        String queryCmd = "";
        String clonedInternalName = "";
        try {
            if (name != null && !name.equals("") && !"null".equals(name)
                    && cloneName != null && !cloneName.equals("")
                    && !"null".equals(cloneName)) {
            	clonedInternalName = AttributeGroup.generateAttributeGroupName(cloneName);
                queryCmd = "copy interface $1 $2 property title value $3 description $4";
            } else {
                throw new Exception(
                        FrameworkProperties
                                .getProperty("emxClassificationModule.AttributeGroup.NameIsNull"));
            ...
            //Execute the command
            MqlUtil.mqlCommand(context, queryCmd, true, name, clonedInternalName, cloneName, cloneDescription);
            AttributeGroup.clonedName = clonedInternalName;
        } catch (Exception ex) {
            throw ex;
        }
    }
     ...
     * @throws exception if the operation fails
     */
    public void modify(Context context, String attrGrpName, String newTitle,
        ...
        try {
            ...
            if (attrGrpName != null && !attrGrpName.equals("")
                ...
                queryCmd = "modify interface $1 name $2 description $3 property title value $4";
            ...
            //Execute the command
            String agName = AttributeGroup.generateAttributeGroupName(newTitle);
            MqlUtil.mqlCommand(context, queryCmd.toString(), true, attrGrpName, agName, newDescription,newTitle);
            AttributeGroup.newName = agName;
   ...
   /**
    ...
    public MapList getAllAttributes(Context context, String[] args)
        ...
        //AttributeTypeList attList = AttributeType.getAttributeTypes(context,
         //       false);
        AttributeTypeList attList = AttributeType.getAll(context);
    ...
    public Vector getAttributeGroupTitle(Context context, String[] args)
            throws Exception {
                    ...
                    columnValues.addElement(strI18nAttributeName.toString());
                        ...
                        if(isPrintMode)
                        {
                          ...
                          //strEncodedName = name.replaceAll("'", "\\'");
                        	AttributeGroup attributeGroup = AttributeGroup.getInstance(context, name);
                        	String attributeTitle = attributeGroup.getTitle();
                        	if(UIUtil.isNullOrEmpty(attributeTitle)) {
                        		attributeTitle = name;
                        	}
                          ...
                          strHTMLAnchorHrefAttr.append(attributeTitle);
                          ...
                          hrefBuffer.append(attributeTitle);
    ...
    public Vector getAttributeGroupName(Context context, String[] args)
        ...
        try {
            ...
            while(itr.hasNext()) {
                ...
                if(!hyperlink.equals("true")){
                    StringBuffer strI18nAttributeName = new StringBuffer();
                    strI18nAttributeName.append("<div align=\"top\"><span class=\"object\">");
                    strI18nAttributeName.append(i18nNow.getAttributeI18NString(
                    att.getName(), strLanguageStr));
                    strI18nAttributeName.append("</span>");
                    strI18nAttributeName.append("</div>");
     ...
     * @throws exception if the operation fails
     */
    public Vector getAttributeGroupCommandTitle(Context context, String[] args)
            throws Exception {
        Vector columnValues = new Vector();
        try {
            HashMap programMap = (HashMap) JPO.unpackArgs(args);
            ...
            while(itr.hasNext()) {
                ...
                else
                {
                    ...
                    strDisplayName = "<span class=\"object\">" +XSSUtil.encodeForXML(context, (String)attributeTitle)+"</span>";
                    ...
                    else
                    {
                        ...
                        String strEncodedName = XSSUtil.encodeForJavaScript(context, attributeTitle);//IR-649285
    ...
    public Vector getAttributeGroupNewWindow(Context context, String[] args)
      ...
      while(itr.hasNext()) {
        ...
        }else
        {
          ...
          href = "emxTree.jsp?treeMenu=type_MCMAttributeGroupTreeMenu&amp;treeLabel=" + strEncodedName + "&amp;objectName=" + name + "&amp;AppendParameters=true&amp;AGName="+ name +"&amp;suiteKey=LibraryCentral";
   ...
   /**
     ...
     * @throws Exception if the operation fails
     */
    public String getAGDisplayName(Context context, String[] args)
    throws Exception {
        HashMap programMap          = (HashMap)JPO.unpackArgs(args);
        HashMap requestMap          = (HashMap)programMap.get("requestMap");
        String attributeGroupTitle   = (String)requestMap.get("treeLabel");
    ...
    throws Exception
    {
        try
        {
            ...
            String newAGTitle        = (String) paramMap.get("New Value");
            String description      = ((String[])requestMap.get("Description"))[0];
            String oldAGName      = ((String[])requestMap.get("AGName"))[0];
            Classification classification = new Classification();
            classification.modifyAttributeGroup(context, oldAGName, newAGTitle, description);
        }
        catch(Exception ex)
        {
            throw new FrameworkException(ex.toString());
    ...
    throws Exception
    {
        try
        {
            ...
            String agName           = null;
            if(UIUtil.isNotNullAndNotEmpty(AttributeGroup.newName)) {
            	agName = AttributeGroup.newName;
            }
            else {
            	agName           = ((String[])requestMap.get("AGName"))[0];
            }
       ...
       File attributeGrpExportFile=null;
        try{
            ...
            if(attributeGroupNames.length == 1){
                ...
                AttributeGroup attrGrp=AttributeGroup.getInstance(context,attributeGroupName);
                String agTitle=attrGrp.getTitle();
                String agDescription=attrGrp.getDescription();
                String agOriginatedDate=attrGrp.getOriginated();
                attributeGrpExportFile=attrGrp.createSingleAGXML(context,attributeGroupName,agTitle,agDescription,agOriginatedDate,allAttrList);
