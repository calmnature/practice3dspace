...
public class emxCommonIssueBase_mxJPO extends emxDomainObject_mxJPO {
        ...
        /** A string constant with the value ~=. */
        public static final String SYMB_SMATCH = " ~= ";
        /** A string constant with the value (match) */
        public static final String SYMB_CSMATCH = " (match) ";
        /** A string constant with the value !~~. */
	...
	static public final String COMMENT_MULTIPLE_OWNERSHIP_FOLLOWER = "Multiple Ownership For Follower";
        ...
        public int mxMain(Context context, String[] args) throws Exception {
            ...
            */
            ...
            public MapList getAllIssues(Context context, String[] args)throws Exception {
               ...
               sbOwnerCondition.append(SYMB_OPEN_PARAN).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_OWNER).append(SYMB_EQUAL).append(SYMB_QUOTE).append(strOwner).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN).append(SYMB_OR).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_ORIGINATOR).append(SYMB_EQUAL).append(SYMB_QUOTE).append(strOwner).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN).append(SYMB_OR);
               //Added to check if Assigned Issue present or not
               sbOwnerCondition.append(SYMB_OPEN_PARAN).append(SYMB_TO).append(SYMB_OPEN_BRACKET).append(strRelationAssignedIssue).append(SYMB_CLOSE_BRACKET).append(SYMB_EQUAL).append("TRUE").append(SYMB_CLOSE_PARAN).append(SYMB_AND);
               //Added to include the Assigned Issues in ALL Filter.
               sbOwnerCondition.append(SYMB_OPEN_PARAN).append(SYMB_TO).append(SYMB_OPEN_BRACKET).append(strRelationAssignedIssue).append(SYMB_CLOSE_BRACKET).append(SYMB_DOT).append(SYMB_FROM).append(SYMB_DOT).append(DomainConstants.SELECT_NAME).append(SYMB_EQUAL).append(SYMB_QUOTE).append(strOwner).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN);
               //Added to include Co-Owners Condition in where clause //
               sbOwnerCondition.append(SYMB_OR).append("( ").append(SYMB_QUOTE).append(context.getUser()).append(SYMB_QUOTE).append(" matchlist ").append(" attribute[" + DomainConstants.ATTRIBUTE_CO_OWNER + "] ").append(" \"~\" )");
               //End Added to include Co-Owners Condition in where clause //
               sbOwnerCondition.append(SYMB_CLOSE_PARAN).append(SYMB_AND).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_CURRENT).append(SYMB_NOT_EQUAL).append(SYMB_QUOTE).append(strClose).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN);
        ...
        public MapList getAssignedIssues(Context context, String[] args)
                ...
                sbOwnerCondition.append(SYMB_OPEN_PARAN).append(SYMB_TO).append(SYMB_OPEN_BRACKET).append(strRelationAssignedIssue).append(SYMB_CLOSE_BRACKET).append(SYMB_DOT).append(SYMB_FROM).append(SYMB_DOT).append(DomainConstants.SELECT_NAME).append(SYMB_EQUAL).append(SYMB_QUOTE).append(context.getUser()).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN).append(SYMB_AND).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_CURRENT).append(SYMB_NOT_EQUAL).append(SYMB_QUOTE).append(strClose).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN);
        ...
        public MapList getOwnedIssues(Context context, String[] args)
                ...
                sbOwnerCondition.append(SYMB_OPEN_PARAN).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_OWNER).append(SYMB_EQUAL).append(SYMB_QUOTE).append(strOwner).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN);
				//Added to include Co-Owners Condition in where clause //
                sbOwnerCondition.append(SYMB_OR).append("( ").append(SYMB_QUOTE).append(context.getUser()).append(SYMB_QUOTE).append(" matchlist ").append(" attribute[" + DomainConstants.ATTRIBUTE_CO_OWNER + "] ").append(" \"~\" )");
				//End Added to include Co-Owners Condition in where clause //
                sbOwnerCondition.append(SYMB_CLOSE_PARAN).append(SYMB_AND).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_CURRENT).append(SYMB_NOT_EQUAL).append(SYMB_QUOTE).append(strClose).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN);
        ...
        */
        ...
        public MapList getAllContextIssues(Context context, String[] args)
              ...
              /*  String strType =
				...
				MapList relIssueList = null;
				try{				
				DomainObject domObj = DomainObject.newInstance(context, strParentId);
				String physicalId = domObj.getInfo(context, DomainConstants.SELECT_PHYSICAL_ID);
					relIssueList = new Issue().getAllIssues(context, physicalId, false, false);
        ...
        public MapList getClosedIssues(Context context, String[] args)
           ...
           /*     String strType =
				...
				DomainObject domObj = DomainObject.newInstance(context, strParentId);
				String physicalId = domObj.getInfo(context, DomainConstants.SELECT_PHYSICAL_ID);
					relIssueList=new Issue().getAllIssues(context, physicalId, false, true);
				}catch(NoClassDefFoundError e){
					//case jars not deployed in the env.
					relIssueList= new MapList();
			    }catch(Exception e){
...
/*                String strActualRelName =
                ...
                String strTypes = "";
                strTypes = FrameworkUtil.getTypesList(BusTypeList);*/
...
//                return relBusObjPageList;
		...
		MapList resultList = new MapList();
            	...
            	try {
					...
					relBusObjPageList=issObj.getAllAffectedItems(context,strObjectId,new StringList(DomainConstants.SELECT_ID));

					Iterator mapListIterator = relBusObjPageList.iterator();
					while (mapListIterator.hasNext()) {
                    	Map iteratedMap = (Map) mapListIterator.next();
                     	String id = (String)iteratedMap.get(DomainConstants.SELECT_ID);
						if(id != null && !"".equals(id)){
							resultList.add(iteratedMap);
						}
					 
		            }

					System.out.println("getAllReportedAgainst- "+relBusObjPageList);
				} catch (Exception e) {
					throw new FrameworkException(e.getMessage());
				}
            	return  resultList;
        ...
        public MapList getAllAssignee(Context context, String[] args)
                ...
                String strRelName =
                        PropertyUtil.getSchemaProperty(context, "relationship_TechnicalAssignee");
	...
	private boolean hasAccess(Context context) throws MatrixException {
		...
		//start
		boolean bIssueManager = false;
        if(!iscloud){
			String roleIssueManager = PropertyUtil.getSchemaProperty(context,Issue.SYMBOLIC_role_IssueManager);
			if(roleIssueManager != null && roleIssueManager.length() > 0){
				bIssueManager = strContextUser.isAssigned(context, roleIssueManager);
			}	
		}
		//end
		...
		//start
		boolean bAnalyst = false;
		if(!iscloud){
			String roleAnalyst = PropertyUtil.getSchemaProperty(context,Issue.SYMBOLIC_role_Analyst);
			if(roleAnalyst != null && roleAnalyst.length() > 0){
				bAnalyst = strContextUser.isAssigned(context, roleAnalyst);
			}
		}
		//end
		
		boolean bVPLMContributor =  strContextUser.isAssigned(context, PropertyUtil.getSchemaProperty(context,"role_VPLMExperimenter"));         
		boolean bSecuredVPLMContributor =  strContextUser.isAssigned(context, PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedContributor"));
		boolean bVPLMAdmin =  strContextUser.isAssigned(context, PropertyUtil.getSchemaProperty(context,"role_VPLMAdmin"));
		boolean bVPLMProjectOwner =  strContextUser.isAssigned(context, PropertyUtil.getSchemaProperty(context,"role_VPLMProjectAdministrator"));
		boolean bSecuredVPLMProjectOwner =  strContextUser.isAssigned(context, PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedOwner"));
		 
		if(bIssueManager || bAnalyst || bVPLMContributor || bVPLMAdmin || bVPLMProjectOwner || bSecuredVPLMContributor || bSecuredVPLMProjectOwner){
			bValidUser = true;
		}
        ...
        if(strVaultOption.equalsIgnoreCase(PersonUtil.SEARCH_DEFAULT_VAULT)
            ...
            if(!ChangeOwner.equals("true"))
            {
				...
				if(!iscloud){
                    ...
                    if(strRoleIssueManager != null && strRoleIssueManager.length() > 0){
                    ...
                    UserList userAnalystList = new UserList();
                    if(strRoleAnalyst != null && strRoleAnalyst.length() > 0){
                    	Role roleAnalyst = new Role(strRoleAnalyst);
                    	userAnalystList = roleAnalyst.getAssignments(context);
                    }
...
//              End : Bug 346997 code modification
                ...
                for (int i = 0; i < iNoOfObjects; i++) {
                           ...
                           !("null".equals(strLaunchMode)) && (strLaunchMode.equals("true"))))
                       {
                        ...
                        strFullName =
                               "<img src = \"images/iconPerson16.png\"><b><A HREF=\"JavaScript:emxTableColumnLinkClick('emxTree.jsp?mode=insert&name="+strLastName+strFirstName+"&treeMenu=type_Person&emxSuiteDirectory="//Modified by Infosys for Bug # 304580 Date 05/18/2005
                                    + strSuiteDir
                                    + "&relId="
                                    + strRelId
                                    + "&parentOID="
...
//                     End : Bug 346997 code modification
        ...
        public int updateCompany(Context context, String[] args) throws Exception
        {
                ...
                // End of add for Bug #311484 by Amrut, Infosys. 10 Nov 2005
                	...
                	if(UIUtil.isNullOrEmpty(strNewValue)){
        ...
        public String getCompanyOrganizationChooserHTML(
                ...
                try {
                        ...
                        strTypeChooser.append(
                                "<img src=\"images/iconCompany16.png\" border=\"0\" alt=\"Company\"></img><b>"
        ...
        public int notifyOriginator(Context context, String[] args)
                ...
                try {
                	boolean mailNotificationEnabled = false;
                   	//check if Mail Notifications for Issue are enabled or not
                	String mailEnabled = EnoviaResourceBundle.getProperty(context, "emxFramework.Issue.EnableMails");
        ...
        */
        ...
        public int notifyAssignees(Context context, String[] args)
                ...
                try {
                	...
                	if(mailNotificationEnabled) {
                        ...
                        String fromName = args[4];
                        String typeGroup = PropertyUtil.getSchemaProperty(context,"type_Group");
                        String typeGroupProxy = PropertyUtil.getSchemaProperty(context,"type_GroupProxy");
                        String relGroupMember = PropertyUtil.getSchemaProperty(context,"relationship_GroupMember");
                        this.setId(strObjectId);
                        String userGroupMemberSelect = "from["+relGroupMember+"].to.name";
                        ...
                        if(typeGroup.equalsIgnoreCase(fromType) || typeGroupProxy.equalsIgnoreCase(fromType)) {
                        	memberList = getInfoList(context, userGroupMemberSelect);
                        	int memberListSize = memberList.size();
                        	if(memberList!=null && memberListSize >0) {
                        		//toList = new StringList(memberListSize);
                        		toList = memberList;
                        	}
                        } else {
        ...
        public int setActualEndDate(Context context, String[] args)
                throws Exception {
                try {
	                	//Using super user context as this is a automated system update
                ...
                try{
                        ...
                        if(strCurrentState.equals(strActualStateName)){
								...
								if(!iscloud){
									...
									if(strRoleIssueManager != null && strRoleIssueManager.length() > 0){
										bIssueManager = pUser.isAssigned(context, strRoleIssueManager);
									}
								}
                        		...
                        		if(!iscloud){
									...
									if(strRoleAnalyst != null && strRoleAnalyst.length() > 0){
										bAnalyst = pUser.isAssigned(context, strRoleAnalyst);
									}
								}
        ...
        public boolean bCommandDisplay(Context context, String[] args) throws Exception {
                ...
                try{
                        ...
                        if(!bFlag)
                        {
                                ...
                                boolean strOwnerOrCoowner = Issue.isOwnerORCoownerOfIssue(context, strObjectId);
                                //Comparing with Context user
                                if(strOwnerOrCoowner)
                                {
                                        bFlag = true;
                                }
								...
								//Initiating the Map List
								MapList mlCoordinatorList = null;
								...
								//Getting the actual relationship name 'Change Coordinator'
								String corrdinatorReln = PropertyUtil.getSchemaProperty(
														context,
														"relationship_ChangeCoordinator");


								//Running the Query to get Coordinators
								mlCoordinatorList =
								...
								int numberOfObjects = mlCoordinatorList .size();

								String coordinatorName = "";
								//Loop to check the Context user is a Coordinator or not.
								for (int i = 0; i < numberOfObjects; i++) {
										coordinatorName = (String)((Hashtable)mlCoordinatorList.get(i)).get(DomainConstants.SELECT_NAME);

										if(coordinatorName.equals(strContextUser))
										{
												bFlag = true;
										}
								}
                                ...
                                if(!bFlag)
                                {
                                        ...
                                        //Getting the actual relationship name 'Technical Assignee'
                                        String strReln = PropertyUtil.getSchemaProperty(
                                                                context,
                                                                "relationship_TechnicalAssignee");
...
public int sendClosingMail(Context context, String[] args)
		...
		if("owner".equals(kindOfOwner)){
			...
			StringList objectSelects = new StringList(DomainConstants.SELECT_OWNER);
			objectSelects.add(DomainConstants.SELECT_ORIGINATOR);
			Map issueInfo = domIssue.getInfo(context, objectSelects);			

			String strOwner = (String) issueInfo.get(DomainConstants.SELECT_OWNER);
			String strOriginator = (String) issueInfo.get(DomainConstants.SELECT_ORIGINATOR);
			...
			//Check if Originator is himself a owner. If yes then the message should be blank. Otherwise message should contain all details			
			message = strOwner.equals(strOriginator) ? "" : Issue.replaceMacroWithValues(context,strObjectId,message);
        ...
        */
        ...
        public MapList getRollupIssues (Context context, String[] args) throws Exception {
               ...
               mulValSelects.add(issueIdSelect);
               mulValSelects.add(issueNameSelect);
               ...
               try{
                   ...
                   Map contextObjIssues = domObj.getInfo(context, objectSelects, mulValSelects);
...
/**
                ...
                throws Exception
        {
            ...
            String showClearButton = (String) settingsMap.get("Show Clear Button");
			...
			//Modified for IR-072793V6R2012 - reversed the strings in equalsIgnoreCase
                ...
                // Modified for the Bug 345286 1 end
  				String fieldClearURL = "";
                String i18strClear = "Clear";
                String languageStr = (String)requestMap.get("languageStr");
                try {
                     i18strClear = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", new Locale(languageStr), "emxFramework.FormComponent.Clear");
                } catch(Exception e) {

                }
                if (showClearButton != null && showClearButton.equalsIgnoreCase("true")) {
                	 fieldClearURL = "<a href=\"javascript:basicClear('" + fieldName
                             + "')\">" + i18strClear + "</a>";
                }
				outStr.append("&nbsp;");
                outStr.append(fieldClearURL);
     ...
     */
             ...
             throws Exception
        {
             ...
             ObjectSelectsList.add (DomainConstants.SELECT_ATTRIBUTE_TITLE);
             ...
             StringBuffer strBufRDOTitle = new StringBuffer();	
             StringBuffer strBufRDOTitleForPrint = new StringBuffer();
             StringBuffer strBufRDOTitleForExport = new StringBuffer();
             ...
             while(mapItr.hasNext())
             {
                  ...
                  if("edit".equalsIgnoreCase(strMode))
                  {
                      ...
                      strBufRDOTitle.append(mapOrg.get(DomainConstants.SELECT_ATTRIBUTE_TITLE));
                      strBufRDOTitle.append(",");
                  }
                  else
                  {
                      String strAccess = "";
                      ...
                      if(strAccess.equalsIgnoreCase("TRUE"))
                      {
                          ...
                          strBufRDONamesForView.append(
                                mapOrg.get(DomainConstants.SELECT_ATTRIBUTE_TITLE)+"</a>");
                             strBufRDONamesForView.append(",");
                      }
                      else
                      {
                       ...
                       if(null!=reportFormat && !reportFormat.equals("null") && (reportFormat.length() > 0))
                       {
                           strBufRDONamesForExport.append(
                               mapOrg.get(DomainConstants.SELECT_ATTRIBUTE_TITLE));
                       }
            ...
            if("edit".equalsIgnoreCase(strMode))
            {
                ...
                if(strBufRDOTitle.length() > 0)
                {
                	strBufRDOTitle.setLength(strBufRDOTitle.length() -1);
                }
                returnString.append(
                    "<input type=\"text\" readonly=\"readonly\"  name=\"RDODisplay\"  value=\""+
                                            XSSUtil.encodeForHTMLAttribute(context,strBufRDOTitle.toString())+"\">");
                returnString.append(
   ...
   /**
             ...
             throws Exception
    {
        ...
        Map map = issue.getInfo(context, selects);
        
        String owner = (String)map.get(DomainConstants.SELECT_OWNER);
        String objectName = (String)map.get(DomainConstants.SELECT_NAME);
        String objectType = (String)map.get(DomainConstants.SELECT_TYPE);

        if(newCoOwners !=null && newCoOwners.size() > 0)
        	newCoOwners.remove(owner);
        
        strNewCoOwners = FrameworkUtil.join(newCoOwners, null);
        
        StringList oldCoOwners = FrameworkUtil.split(strOldCoOwners,"~");
        
   /*     setAttributeValue(context,
                ATTRIBUTE_CO_OWNER, strNewCoOwners);
            issue.updateIssueCoOwnerOwnership(context, strIssueID, oldCoOwners,newCoOwners);
*/
		// ISU 23x - new API/SCHEMA 
		// add new users
		new Issue().addCoowners(context, strIssueID, newCoOwners.toList());
		// remove old coowners
		new Issue().removeCoowners(context, strIssueID, oldCoOwners.toList());
        
        StringList addedCoOwners = new StringList(newCoOwners.size());
        addedCoOwners.addAll(newCoOwners);
        addedCoOwners.removeAll(oldCoOwners);
        
        // Sends mail notification to the owners.
        StringList objectIdList = new StringList(1);
        objectIdList.addElement(getId(context));
        
        String[] subjectKeys = {"type", "name"};
        String[] subjectValues = {objectType, objectName};

        String[] messageKeys = {"type", "name"};
        String[] messageValues = {objectType, objectName};

        MailUtil.sendNotification(context,
                        addedCoOwners,
                        null,
                        null,
                        FrameworkStringResource.MultipleOwnerManager_AddCoOwnerSubject,
                        subjectKeys,
                        subjectValues,
                        FrameworkStringResource.MultipleOwnerManager_AddCoOwnerMessage,
                        messageKeys,
                        messageValues,
                        objectIdList,
                        Company.getCompanyForKey(context, Person.getCompanyKey(context)).getName());
        }
    }

        /**
		* Gets the Coowners
		* This is used in the display of properties page of the object, normally called from Webform.
		* @param context the eMatrix <code>Context</code> object.
		* @param args holds the following input arguments:
		* 0 - String containing the object id.
		* @return String of Coowners 
		* @throws Exception if the operation fails.
		*/
		public String getCoOwners(Context context,String[] args)
			 throws Exception
		{
			 String coowners = "";
			 HashMap programMap = (HashMap) JPO.unpackArgs(args);
			...
			// ISU 23x - new API/SCHEMA 
			coowners = new Issue().getCoOwners(context, objectId);
		...
		/**
		* Gets the Coowners
		* This is used in the display of coowners column on summary page of the object, normally called from WebTable.
		* @param context the eMatrix <code>Context</code> object.
		* @param args holds the following input arguments:
		* @return Vector of Coowners 
		* @throws Exception if the operation fails.
		*/
		public Vector getCoOwnersInTable(Context context, String[] args) throws Exception {
		   HashMap programMap = ( HashMap ) JPO.unpackArgs( args );
		   MapList mapList = ( MapList )programMap.get( "objectList" );
		   HashMap paramMap = (HashMap) programMap.get("paramList");
		   boolean bPrintMode = false;
		   if("true".equalsIgnoreCase((String)paramMap.get("editTableMode"))) {
			   bPrintMode = true;
		   }
		   ...
		   for(int i=0; i<mapList.size(); i++) {
			   ...
			   if(bPrintMode) {				
				String coowners = new Issue().getCoOwners(context, objectId);
				vec.add(coowners );			
			   }
		   }
        ...
        public boolean showRollupIssue(Context context, String[] args)
            ...
            if(!(strObjectId == null || "".equals(strObjectId)))
            {
                ...
                if (strParentType.equals(TYPE_LIBRARIES)||strParentType.equals(TYPE_CLASSIFICATION))
                {
                    ...
                    String role_SecuredVPLMProjectLeader=PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedLeader");
                    String role_SecuredVPLMProjectAdministrator=PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedOwner");
                    ...
                    || pUser.isAssigned(context, role_SecuredVPLMProjectLeader)
                    || pUser.isAssigned(context, role_SecuredVPLMProjectAdministrator);
                }
                else {
                    DomainObject dom = new DomainObject(strObjectId);
                    if (strParentType.equals(TYPE_DOCUMENTS))
             ...
             throws Exception
        {
            ...
            for(int i=0; i<relBusObjPageList.size(); i++)
            {
                ...
                if(!(strObjectId == null || "".equals(strObjectId)))
                {
					...
					//23x ISU new schema ---
                    MapList relBusObjPageList2 =new Issue().getAllAffectedItems(context, strObjectId, new StringList(DomainConstants.SELECT_ID));
                    StringList slRepAgainstIds = new StringList();
                    Iterator mapListIterator = relBusObjPageList2.iterator();
                    while (mapListIterator.hasNext()) {
						Map iteratedMap = (Map) mapListIterator.next();
						String stroids = (String)iteratedMap.get(DomainConstants.SELECT_ID);

						if(stroids != null && !"".equals(stroids)){
							slRepAgainstIds.add(stroids);
						}		            
					 }

					System.out.println("slRepAgainstIds=>"+slRepAgainstIds);
					//23x ISU new schema ---					
                    ...
                    while(repAgainstIdItr.hasNext()) {
                        ...
                        slRepAgainst.add(DomainObject.SELECT_ATTRIBUTE_TITLE);
                        slRepAgainst.add("type.kindof["+ DomainConstants.TYPE_PROJECT_SPACE +"]");
                        slRepAgainst.add("type.kindof["+ DomainConstants.TYPE_PROJECT_TEMPLATE +"]");
                        slRepAgainst.add("type.kindof["+ DomainConstants.TYPE_PROGRAM +"]");
                        slRepAgainst.add("type.kindof["+ DomainConstants.TYPE_PROJECT_CONCEPT +"]");
						...
						try {
							...
							String strRepAgainstTitle = (String) mapRepAgainst.get(DomainConstants.SELECT_ATTRIBUTE_TITLE);
							String strRepAgainstName = (String) mapRepAgainst.get(DomainConstants.SELECT_NAME);
							boolean isProjectType =  "true".equalsIgnoreCase((String)mapRepAgainst.get("type.kindof["+ DomainConstants.TYPE_PROJECT_SPACE +"]")) || "true".equalsIgnoreCase((String)mapRepAgainst.get("type.kindof["+ DomainConstants.TYPE_PROJECT_TEMPLATE +"]")) || "true".equalsIgnoreCase((String)mapRepAgainst.get("type.kindof["+ DomainConstants.TYPE_PROGRAM +"]")) || "true".equalsIgnoreCase((String)mapRepAgainst.get("type.kindof["+ DomainConstants.TYPE_PROJECT_CONCEPT +"]")); 
							String strRepAgainstRev = (String) mapRepAgainst.get(DomainConstants.SELECT_REVISION);
							strRepAgainstType=i18nNow.getTypeI18NString(strRepAgainstType, context.getLocale().getCountry());
							String URLToShow = "../common/emxTree.jsp?objectId="
													  + XSSUtil.encodeForJavaScript(context,strRepAgainstId);

							if((paramList.get("reportFormat")) != null)
							{
								strShowLink = (strShowLink == null) ? "" : (strShowLink + "\n");
								if (isProjectType && strRepAgainstTitle != null && !"".equalsIgnoreCase(strRepAgainstTitle)) {
									strShowLink += strRepAgainstTitle;
								...
								if (isProjectType && strRepAgainstTitle != null && !"".equalsIgnoreCase(strRepAgainstTitle)) {
									strShowLink += "<a href=\"javascript:showModalDialog(\'" +
											URLToShow + "\',700,600,false)\">" + XSSUtil.encodeForXML(context,strRepAgainstTitle) + " " + XSSUtil.encodeForXML(context,strRepAgainstRev) + "</a>";
...
// IR-060833V6R2011x modification -Ends
	...
	@com.matrixone.apps.framework.ui.ProgramCallable
	    public MapList getIssuescockpitItems(Context context, String[] args) throws Exception {
	        ...
	        sbWhere.append(" ((from[").append(PropertyUtil.getSchemaProperty(context, "relationship_TechnicalAssignee"));
	        sbWhere.append("] == TRUE").append(") && ");
	        sbWhere.append(" (from[").append(PropertyUtil.getSchemaProperty(context, "relationship_TechnicalAssignee"));
	        sbWhere.append("].to == '").append(context.getUser()).append("')) ||");
	        sbWhere.append(" ((from[").append(PropertyUtil.getSchemaProperty(context, "relationship_TechnicalAssignee"));
	        sbWhere.append("] == TRUE").append(") && ");
	        sbWhere.append(" (from[").append(PropertyUtil.getSchemaProperty(context, "relationship_TechnicalAssignee"));
	        sbWhere.append("].to[Group Proxy].from[").append(PropertyUtil.getSchemaProperty(context, "relationship_GroupMember")).append("].to == '").append(context.getUser()).append("')) ||");
	        sbWhere.append(" ((from[").append(PropertyUtil.getSchemaProperty(context, "relationship_ChangeCoordinator"));
	        sbWhere.append("] == TRUE").append(") && ");
	        sbWhere.append(" (from[").append(PropertyUtil.getSchemaProperty(context, "relationship_ChangeCoordinator"));
	        sbWhere.append("].to == '").append(context.getUser()).append("')))");
	        ...
	        sbWhere.append(" && ("+DomainConstants.SELECT_POLICY+" == '").append(PropertyUtil.getSchemaProperty(context, "policy_Issue")).append("')");
	        String strType = PropertyUtil.getSchemaProperty(context, Issue.SYMBOLIC_type_Issue);
	        String sbWhererStr = FrameworkUtil.getWhereExpressionForMql(context, sbWhere.toString(), strType);
	        sbWhere = new StringBuilder(sbWhererStr);
   	...
   	public static Object excludeIssueRelatedObjects(Context context, String[] args ) throws Exception
   	{
   		...
   		try
   		{
			...
			String mode = (String)paramMap.get("mode");
   			...
   			String rdfSelectString = "";
   			if(isRDFQuery && UINavigatorUtil.isCloud(context)) {
   				strtype.append(PropertyUtil.getSchemaProperty(context,"type_GroupProxy"));
   				rdfSelectString = "attribute["+PropertyUtil.getSchemaProperty(context,"attribute_GroupURI")+"]";
   			} else if(UIUtil.isNotNullAndNotEmpty(strFieldtype)){
   	       ...
   	       int k =strToken.countTokens();
   			while(strToken.hasMoreTokens())
   			{
   				...
   				String symbolicName = UIUtil.isNullOrEmpty(PropertyUtil.getSchemaProperty(context,temp[0]))? temp[0] :PropertyUtil.getSchemaProperty(context,temp[0]); 
   				strtype.append(symbolicName);
   				if(k!=++i)
   				{
   					strtype.append(",");
   				}
   			...
   			selectList.add(DomainConstants.SELECT_ID);
   				...
   				selectList.add(rdfSelectString);
   			}	
   			 boolean from =false;
   			 boolean to=false;
/*   			if("true".equalsIgnoreCase((String)paramMap.get("isTo")))
   			...
   			String referenceDocumentRel = PropertyUtil.getSchemaProperty(context,"relationship_ReferenceDocument");
   			String resolvedToRel = PropertyUtil.getSchemaProperty(context,"relationship_ResolvedTo");
   			
   			if("IssueaddAsignee".equalsIgnoreCase(mode)){
					rel =PropertyUtil.getSchemaProperty(context,"relationship_TechnicalAssignee");
			}
   			if(UIUtil.isNotNullAndNotEmpty(rel) && (rel.equalsIgnoreCase(resolvedToRel) || rel.equalsIgnoreCase(issueRel) ||  rel.equalsIgnoreCase(referenceDocumentRel) )){  				
   				rel = issueRel + "," + referenceDocumentRel + "," + resolvedToRel;
   			}
   			...
   			if ( mlist.size() >0)
      			{
      				...
      				while (itr.hasNext())
      				{
      					map = (Map) itr.next();
      					if(isRDFQuery) {
      						excludeOID.add((String)map.get(rdfSelectString));
      					} else {
  ...
  @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
 	public static StringList excludeIssueReportedAgainst(Context context, String[] args ) throws Exception
  {
	  StringList excludeOID = new StringList();
	  HashMap programMap = (HashMap)JPO.unpackArgs(args);
	  ...
	  try
	  {  
		  MapList relBusObjPageList =new Issue().getAllAffectedItems(context, strParentId, new StringList(DomainConstants.SELECT_ID));
		  StringList slPhysicalIDs = new StringList();
		  Iterator mapListIterator = relBusObjPageList.iterator();
		  while (mapListIterator.hasNext()) {
			  Map iteratedMap = (Map) mapListIterator.next();
			  String stroids = (String)iteratedMap.get(DomainConstants.SELECT_ID);
			  excludeOID.add(stroids);
		  }
		  return excludeOID;
	  }
	  catch (Exception ex)
  ...
  @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
 	public static StringList excludeIssueResolvedItem(Context context, String[] args ) throws Exception
  {
	  StringList excludeOID = new StringList();
	  HashMap programMap = (HashMap)JPO.unpackArgs(args);
	  String strParentId = (String)programMap.get("objectId");
	  try
	  {  
		  MapList relBusObjPageList =new Issue().getAllSatisfiedItems(context, strParentId);
		  StringList slPhysicalIDs = new StringList();
		  Iterator mapListIterator = relBusObjPageList.iterator();
		  while (mapListIterator.hasNext()) {
			  Map iteratedMap = (Map) mapListIterator.next();
...
public Object getContextObjAsReportedAgainst(Context context, String[] args)
	...
	StringBuilder strReturnContextObjList = new StringBuilder();
	StringBuilder strContextObjectIdList = new StringBuilder();
		HashMap programMap = (HashMap) JPO.unpackArgs(args);
		HashMap paramMap = (HashMap) programMap.get("paramMap");
		HashMap requestMap = (HashMap) programMap.get("requestMap");
		String strResolvedTo = (String) requestMap.get("resolvedTo");
		String emxTableRowId = (String) requestMap.get("emxTableRowIds");
		StringList strRowIdList = FrameworkUtil.split(emxTableRowId,":");
		StringList strSelectedItemList = new StringList();
		String parentOID = (String) requestMap.get("parentOID");
		String objectID = (String) requestMap.get("objectId");
		
		if(UIUtil.isNullOrEmpty(parentOID)){
			parentOID = (String) (String) programMap.get("parentOID");
		}
		if(UIUtil.isNotNullAndNotEmpty(objectID)){
			parentOID = objectID;
		}
		if (strRowIdList != null && UIUtil.isNullOrEmpty(parentOID))	{
			for(int i=0;i<strRowIdList.size();i++){
			 	String objectId1 = strRowIdList.get(i).trim();
			    if(objectId1.indexOf("|") != -1)
			    {
			        StringList objectIdList1 = FrameworkUtil.split(objectId1, "|");
			        //objectIdList.size() will be 3 for root node
			        if (objectIdList1.size() == 3)
			        {
			        	objectId1 = (String)objectIdList1.get(0);
			        }
			        else
			        {
			        	objectId1 = (String)objectIdList1.get(1);
			        }
			    }
			    strSelectedItemList.add(objectId1);
			}
		}	
	
	StringList objectList = new StringList();
	if(UIUtil.isNullOrEmpty(parentOID)) {
		for(int i=0;i<strSelectedItemList.size();i++){
			String tempId =  (String)strSelectedItemList.get(i);
			if(UIUtil.isNotNullAndNotEmpty(tempId) && FrameworkUtil.isObjectId(context,tempId)){
				objectList.add(tempId);
			}  	
		}
	}else if(UIUtil.isNullOrEmpty(strResolvedTo)){
		objectList.add(parentOID);
	}

	String[] strRowIds = new String[objectList.size()];
	for(int i = 0;i<objectList.size();i++){
		strRowIds[i] = (String)objectList.get(i);
	 	}
	
	StringList select1 = new StringList(3);
	select1.add(DomainConstants.SELECT_ID);
	select1.add(DomainConstants.SELECT_NAME);
	select1.add(DomainConstants.SELECT_ATTRIBUTE_TITLE);
	select1.add("type.kindof["+ DomainConstants.TYPE_PROJECT_SPACE +"]");
	select1.add("type.kindof["+ DomainConstants.TYPE_PROJECT_TEMPLATE +"]");
	select1.add("type.kindof["+ DomainConstants.TYPE_PROGRAM +"]");
    select1.add("type.kindof["+ DomainConstants.TYPE_PROJECT_CONCEPT +"]");
	String objectName="";
	String objectTitle = "";
	String objectId = "";
	MapList mapList = DomainObject.getInfo(context, strRowIds,select1);
	...
	while ( iterator.hasNext()) {
		...
		objectTitle = (String)map.get(DomainConstants.SELECT_ATTRIBUTE_TITLE);
	    boolean isProjectType =  "true".equalsIgnoreCase((String)map.get("type.kindof["+ DomainConstants.TYPE_PROJECT_SPACE +"]")) || "true".equalsIgnoreCase((String)map.get("type.kindof["+ DomainConstants.TYPE_PROJECT_TEMPLATE +"]")) || "true".equalsIgnoreCase((String)map.get("type.kindof["+ DomainConstants.TYPE_PROGRAM +"]")) || "true".equalsIgnoreCase((String)map.get("type.kindof["+ DomainConstants.TYPE_PROJECT_CONCEPT +"]")); 

		if (isProjectType && objectTitle != null && !"".equalsIgnoreCase(objectTitle)) {
			objectName = objectTitle;
		}
		objectId = (String)map.get(DomainConstants.SELECT_ID);
		strReturnContextObjList.append(seperator).append(objectName);
		strContextObjectIdList.append(seperator).append(objectId);
		seperator = "|";
	}
	sbReturnString.append("<input type=\"text\" name=\"Reported Against1Display\" id=\"\" readonly=\"true\" value=\"" +XSSUtil.encodeForXML(context,strReturnContextObjList.toString())+ "\" maxlength=\"\" size=\"\"></input>");
	sbReturnString.append("<input type=\"hidden\" name=\"Reported Against1\" value=\""+XSSUtil.encodeForXML(context,strReturnContextObjList.toString())+"\"></input>");
	sbReturnString.append("<input type=\"hidden\" name=\"Reported Against1OID\" value=\""+XSSUtil.encodeForXML(context, strContextObjectIdList.toString())+"\"></input>");
...
public static boolean checkIssueCreateContext(Context context, String args[]) throws Exception
{
		...
		if ((UIUtil.isNotNullAndNotEmpty(strContextObjectId) || UIUtil.isNotNullAndNotEmpty(emxTableRowIds)) && UIUtil.isNullOrEmpty(strResolvedTo)) {
			bFlag = true;
		}
		return bFlag;
}
...
public void updateReportedAgainst(Context context, String[] args)
		...
		String sIssueId = (String) paramMap.get("objectId");
		String strReportedObjs = (String) paramMap.get("New OID");
		DomainObject issueDomObj = DomainObject.newInstance(context, sIssueId);
		List<String> fromObjectIds = new ArrayList<String>();
		if(UIUtil.isNullOrEmpty(strReportedObjs)){
			String message = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource",
					context.getLocale(), "emxFramework.FormComponent.MustEnterAValidValueFor") + " " + EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource",
							context.getLocale(), "emxComponents.Form.Label.AffectedItem");
			throw new Exception(message);
		}

		StringList selectables = new StringList(DomainObject.SELECT_PHYSICAL_ID);

	//	String strRelIssue = PropertyUtil.getSchemaProperty(context, Issue.SYMBOLIC_relationship_Issue);
			fromObjectIds = Arrays.asList(strReportedObjs.split("\\|"));
						MapList physicalIdMapList = (MapList) DomainObject.getInfo(context, strReportedObjs.split("\\|"), selectables);
                        if(fromObjectIds.size() > 0) {
				for(int i=0;i<fromObjectIds.size();i++){
		/*	DomainRelationship.connect(context, issueDomObj, strRelIssue,
							new DomainObject(fromObjectIds.get(i)));*/
					Map map = (Map) physicalIdMapList.get(i);
					String physicalId = (String) map.get(DomainObject.SELECT_PHYSICAL_ID);
					
			if (physicalId != null && !"".equalsIgnoreCase(physicalId) ) {	
			new Issue().addAffectedItem(context, sIssueId, physicalId);
			}
				}
			}
		}
...
public void updateIssueDetails(Context context, String[] args)
	...
	boolean isIssueCategorySelected = false;
	com.matrixone.apps.common.Issue issObj = new com.matrixone.apps.common.Issue();
	issObj.setId(sIssueId);
	
	String strOriginator = issObj.getInfo(context, DomainConstants.SELECT_ORIGINATOR);
	/*if (!"User Agent".equalsIgnoreCase(strOriginator) && UIUtil.isNotNullAndNotEmpty(strOriginator)) {
    	DomainAccess.createObjectOwnership(context, sIssueId, "",strOriginator+"_PRJ","read,show", DomainAccess.COMMENT_MULTIPLE_OWNERSHIP,false);
	}*/
	if (UIUtil.isNotNullAndNotEmpty(strIssueCategoryClassification)) {
		isIssueCategorySelected = true;
		if (!"User Agent".equalsIgnoreCase(strOriginator) && UIUtil.isNotNullAndNotEmpty(strOriginator)) {
			DomainAccess.createObjectOwnership(context, sIssueId, "",strOriginator+"_PRJ","toconnect,todisconnect,modify,changesov,changeowner","TEMP OWNERSHIP",false);
		}
	...
	String owner = (String) issObj.getInfo(context,DomainConstants.SELECT_OWNER);
	...
	/*if (UIUtil.isNotNullAndNotEmpty(owner)) {
		StringList accessNames = DomainAccess.getLogicalNames(context, sIssueId);
    	String fullAccess = (String)accessNames.get(accessNames.size()-1);
    	DomainAccess.createObjectOwnership(context, sIssueId, "",owner+"_PRJ",fullAccess, DomainAccess.COMMENT_MULTIPLE_OWNERSHIP,false);
	}*/
	...
	if (isIssueCategorySelected) {
		if(!"User Agent".equalsIgnoreCase(strOriginator) && UIUtil.isNotNullAndNotEmpty(strOriginator)){
			DomainAccess.deleteObjectOwnership(context, sIssueId, "",strOriginator+"_PRJ","TEMP OWNERSHIP",true);
		}
	}
}
...
/*	String strnewCoOwners = FrameworkUtil.join(newCoOwners, null);
		issue.updateIssueCoOwnerOwnership(context, issue.getObjectId(), new StringList(),newCoOwners);
		issue.setAttributeValue(context,ATTRIBUTE_CO_OWNER, strnewCoOwners);
*/
	// ISU 23x - new API/SCHEMA 
	new Issue().addCoowners(context,issue.getObjectId(),newCoOwners.toList());
	...
	String objectType = (String)map.get(DomainConstants.SELECT_TYPE);
	StringList objectIdList = new StringList(1);
	objectIdList.addElement(issue.getObjectId());
...
public void updateIssueClassification(Context context, String[] args)
      throws Exception
{
	HashMap programMap = (HashMap) JPO.unpackArgs(args);
	HashMap paramMap = (HashMap) programMap.get("paramMap");
	...
	Map requestMap = (Map)programMap.get("requestMap");
	com.matrixone.apps.common.Issue issObj = new com.matrixone.apps.common.Issue();
	issObj.setId(strObjId);
	String[] strIssueCategoryClassification = (String[]) requestMap.get("Category Classification");
	String[] strIssueCategoryClassificationId = (String[]) requestMap.get("Category ClassificationOID");
	if (strIssueCategoryClassification.length == 1 && UIUtil.isNotNullAndNotEmpty(strIssueCategoryClassification[0])) {
		updateIssueWithCategoryClassification(context, issObj, strIssueCategoryClassification[0], strIssueCategoryClassificationId[0]);	
	}else{
		Map attributeMap = new HashMap();
		attributeMap.put(PropertyUtil.getSchemaProperty(context, SYMBOLIC_attribute_IssueCategory),"");
		attributeMap.put(PropertyUtil.getSchemaProperty(context,SYMBOLIC_attribute_IssueClassification),"");
		issObj.setAttributeValues(context, attributeMap);
	}
}
/**
 * Method to check for display for the Category Classification field
 *
 * @param context - the eMatrix <code>Context</code> object
 * @param args - args contains a Map with the following entries
 *                      objectId - Object Id of the Context object
 ...
 * @since 2017x
 */
public boolean showCategoryClassificationField(Context context, String[] args) throws Exception {
	try{
		//Unpacking the arguments
		HashMap programMap = (HashMap) JPO.unpackArgs(args);
		...
		DomainObject domIssueObj = newInstance(context, objectId);
		Map infoMap = domIssueObj.getInfo(context, selects);
		String hasChangeOwnerAccess = (String)infoMap.get(DomainConstants.SELECT_HAS_CHANGEOWNER_ACCESS);
		String currentState = (String)infoMap.get(DomainConstants.SELECT_CURRENT);
		StateList stateList = domIssueObj.getStates(context);
		int lastStateIndex = stateList.size() - 1;
		State closedState = (State)stateList.get(lastStateIndex);
		State reviewState = (State)stateList.get(lastStateIndex-1);
		if (closedState.getName().equals(currentState) || reviewState.getName().equals(currentState)) {
			return false;
		}
		if (!"true".equalsIgnoreCase(hasChangeOwnerAccess)) {
			return false;
		}
...
/**
 * Method to check for display for the Category OR Classification field
 *
 * @param context - the eMatrix <code>Context</code> object
 * @param args - args contains a Map with the following entries
 *                      objectId - Object Id of the Context object
 ...
 * @since 2017x
 */
public boolean showIssueCategoryOrIssueClassificationField(Context context, String[] args) throws Exception {
	boolean bFlag;
	try{
		//Unpacking the arguments
		HashMap programMap = (HashMap) JPO.unpackArgs(args);
...
* @param args holds the following input arguments:
* 0 - String containing the object id.
* @return String of Category Classification connected to the Object
* @throws Exception if the operation fails.
 * @since Common 11.0
*/

public String getCategoryClassification(Context context,String[] args)
     throws Exception
{
	 String displayValue = "";
     StringBuffer returnString=new StringBuffer();
     StringList issueCategory = (StringList)getIssueCategory(context,args);
     StringList issueClassification = (StringList)getIssueClassification(context,args);
     if(UIUtil.isNotNullAndNotEmpty(issueCategory.get(0)))
      displayValue = issueCategory.get(0)+"/"+issueClassification.get(0);
 ...
 */
   ...
   public MapList getIssueCategoryList(Context context, String[] args) throws FrameworkException
   {
	    ...
	    try {
	    	...
	    	strWhereExpression = FrameworkUtil.getWhereExpressionForMql(context,strWhereExpression,strType) ;
...
public String getIssueMangersList(Context context, String[] args) throws Exception {
		boolean iscloud = UINavigatorUtil.isCloud(context);
		String issueManagerList = "USERROLE=";
		if(!iscloud){
			issueManagerList = issueManagerList + PropertyUtil.getSchemaProperty(context, Issue.SYMBOLIC_role_IssueManager) + "," ;
		}
		issueManagerList = issueManagerList + PropertyUtil.getSchemaProperty(context,"role_VPLMExperimenter")+ "," + PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedContributor") + "," + PropertyUtil.getSchemaProperty(context,"role_3DSRestrictedOwner")  + "," + PropertyUtil.getSchemaProperty(context,"role_VPLMAdmin") + "," + PropertyUtil.getSchemaProperty(context,"role_VPLMProjectAdministrator");
    ...
    */
      @com.matrixone.apps.framework.ui.ProgramCallable
   public String getReportedAgainstTypes(Context context, String[] args) throws Exception {
 
    	  String relType = PropertyUtil.getSchemaProperty("relationship_Issue");
    	  ...
    	  return "TYPES="+searchTypes+":IS_VERSION_OBJECT!=True";
   }
...
public MapList getExcludeIssueClassificationList(Context context, String[] args) throws Exception {
	...
	try {
		...
		StringList mulValSelects = new StringList();		
		mulValSelects.add("from["+DomainConstants.RELATIONSHIP_ISSUECATEGORYCLASSIFICATION+"].to.id");
		
		Map relIdMap = rowId.getInfo(context, selectList, mulValSelects);	
 ...
 */
 ...
 public MapList issueCategoryClassificationExpand(Context context, String[] args) throws FrameworkException {
	...
	public Vector getEditIcon(Context context, String[] args) throws Exception {
	   ...
	   for(int i=0; i<mapList.size(); i++) {
		   ...
		   if(bExport ||  "false".equalsIgnoreCase(modifyAccess)) {
			   ...
			   String sHref ="../common/emxForm.jsp?form=type_Issue&mode=Edit&formHeader=emxComponents.Heading.Edit&HelpMarker=emxhelpissueedit&submitAction=refreshCaller&openerFrame=frameTable&suiteKey=Components&objectId=";
			   sHref = sHref.replace("&", "&amp;");
	...
	//edit access program for form fields
	public static boolean canEditIssueFields(Context context, String args[]) throws Exception {
    	HashMap inputMap = (HashMap)JPO.unpackArgs(args);
    	...
    	boolean isEditable = Issue.isOwnerORCoownerOfIssue(context, objectId);
    	DomainObject issueObject = new DomainObject(objectId);
    	String strCurrentState = issueObject.getInfo(context, DomainConstants.SELECT_CURRENT);
    	StateList stateList = issueObject.getStates(context);
    	int lastStateIndex = stateList.size() - 1;
        State lastState = (State)stateList.get(lastStateIndex);
        if (lastState.getName().equals(strCurrentState) && isEditable) {
            return false;
        }
		return isEditable;
	}
	...
	//edit access program for form fields
	public static boolean canEditCoownerField(Context context, String args[]) throws Exception {
    	/*HashMap inputMap = (HashMap)JPO.unpackArgs(args);
    	HashMap requestMap    = (HashMap) inputMap.get("requestMap");
    	String objectId = null;
    	if(requestMap == null){
    	...
    	DomainObject issueObject = new DomainObject(objectId);
    	String hasChangeSOV = issueObject.getInfo(context, DomainConstants.SELECT_HAS_CHANGESOV_ACCESS);
    	if("true".equalsIgnoreCase(hasChangeSOV)){
    		return true;
    	}else{
    		return false;
    	}*/
                ...
                if("owner".equals(kindOfOwner)){
                	...
                	if(UIUtil.isNotNullAndNotEmpty(oldOwner)){              			
               			...
               			if ("true".equalsIgnoreCase((String)busMap.get(DomainConstants.SELECT_HAS_CHANGESOV_ACCESS)) && oldOwner.equals(result)) { 
               				DomainAccess.deleteObjectOwnership(context, strObjectId, "", oldOwner+"_PRJ", DomainAccess.COMMENT_MULTIPLE_OWNERSHIP, false);                  	      
               			}
                	} 
    ...
    public boolean removeAssigneeCommandDisplay(Context context, String[] args) throws Exception {
	   ...
	   /** To exclude the objects already added to the context object using 'Resolved To' relationship
  * @param context
  * @param args
  ...
  */
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList getExcludeResolvedItemsList(Context context, String[] args)
    		throws Exception {
    	...
    	Iterator mapIterator = relBusObjPageList.iterator();
    	String id = null;
    	Map tempmap = null;
    	while(mapIterator.hasNext()){
    		tempmap = (Hashtable)mapIterator.next();
    		id =(String) tempmap.get(DomainConstants.SELECT_ID);
    		ids.add(id);
    	}
    	ids.add(strParentId);
    	return ids;
	}
	public int updateOwnershipOnCoownerChange(Context context , String[] args){
		try{
			String type = args[0];
			String name = args[1];
			String objectId = args[2];
			String newCoowner = args[3];
			String oldCoowner = args[4];
			final String TYPE_ISSUE = PropertyUtil.getSchemaProperty(context, "type_Issue");
			if(type.equalsIgnoreCase(TYPE_ISSUE)){
				String commentForType ="Ownership Inheritance from " + name;    
				List<String> tempNewCoowners = Arrays.asList(newCoowner.split("~"));
				List<String> tempOldCoowners = Arrays.asList(oldCoowner.split("~"));
				List<String> listNewCoowners   = new ArrayList<String>();
				List<String> listOldCoowners   = new ArrayList<String>();

				for(int i=0;i<tempNewCoowners.size();i++){
					if(!tempOldCoowners.contains(tempNewCoowners.get(i)) && UIUtil.isNotNullAndNotEmpty(tempNewCoowners.get(i))){
						listNewCoowners.add(tempNewCoowners.get(i));
					}
				}

				for(int i=0;i<tempOldCoowners.size();i++){
					if(!tempNewCoowners.contains(tempOldCoowners.get(i)) && UIUtil.isNotNullAndNotEmpty(tempOldCoowners.get(i))){
						listOldCoowners.add(tempOldCoowners.get(i));
					}
				}

				StringList reportedAgainstObjects = DomainAccess.getReportedAgainstObject(context, objectId);
				if(listOldCoowners.size() > 0){
					for(int i = 0 ; i < listOldCoowners.size() ; i++){
						String personName = listOldCoowners.get(i);
						for(Object objectAsReportedAgainst : reportedAgainstObjects){
							String connectedID = (String)objectAsReportedAgainst;
							DomainAccess.deleteObjectOwnership(context, connectedID, "", personName+"_PRJ", commentForType , true);       	
						}
					}
				}

				if(listNewCoowners.size() > 0){
					for(int i = 0 ; i < listNewCoowners.size() ; i++){
						String personName = listNewCoowners.get(i);
						for(Object objectAsReportedAgainst : reportedAgainstObjects){
							String connectedID = (String)objectAsReportedAgainst;
							String lowestAccess = DomainAccess.getReaderAccessName(context, connectedID);
							try {
								ContextUtil.pushContext(context, null, null, null);
								DomainAccess.createObjectOwnership(context, connectedID,"", personName+"_PRJ", lowestAccess, commentForType,false);
							}finally{
								ContextUtil.popContext(context);
							}
	...
	public boolean updateOwnershipForFollowers(Context context , String[] args){
		try{
			String toId = args[0];
			String fromId = args[1];           
			String fromType = args[2];
			String fromName = args[3];//Person Name
			String toName = args[4];//Issue name 
			...
			String typeGroup = PropertyUtil.getSchemaProperty(context,"type_Group");
			String typeGroupProxy = PropertyUtil.getSchemaProperty(context,"type_GroupProxy");
			String commentForType ="Ownership Inheritance from " + toName; 
			if ("true".equalsIgnoreCase((String)busMap.get(DomainConstants.SELECT_HAS_CHANGESOV_ACCESS))) { 
				if(typeGroup.equalsIgnoreCase(fromType) || typeGroupProxy.equalsIgnoreCase(fromType)) {
					DomainAccess.createObjectOwnershipForUserGroups(context, toId, fromName, defaultAccess, COMMENT_MULTIPLE_OWNERSHIP_FOLLOWER);
				} else {
					DomainAccess.createObjectOwnership(context, toId, fromId, defaultAccess, COMMENT_MULTIPLE_OWNERSHIP_FOLLOWER);
				}	
			}
			// StringList reportedAgainstObjects = DomainAccess.getReportedAgainstObject(context, toId);
			// for(Object objectAsReportedAgainst : reportedAgainstObjects){
			// 	String connectedID = (String)objectAsReportedAgainst;
			// 	String lowestAccess = DomainAccess.getReaderAccessName(context, connectedID);
			// 	try {
			// 		ContextUtil.pushContext(context, null, null, null);
			// 		DomainAccess.createObjectOwnership(context, connectedID,"", fromName+"_PRJ", lowestAccess, commentForType,false);
			// 	}finally{
			// 		ContextUtil.popContext(context);
			// 	}
			// }
	...
	public boolean clearOwnershipForFollowers(Context context , String[] args){
		try{
			String toId = args[0];
			String fromId = args[1];           
			String fromType = args[2];
			...
			if ("true".equalsIgnoreCase((String)busMap.get(DomainConstants.SELECT_HAS_CHANGESOV_ACCESS))) { 
				if(typeGroup.equalsIgnoreCase(fromType) || typeGroupProxy.equalsIgnoreCase(fromType)) {
					DomainAccess.deleteObjectOwnership(context, toId, "",fromName, COMMENT_MULTIPLE_OWNERSHIP_FOLLOWER, false);
				} else {
		 		    String cmd = "print role $1 select person dump";
					String result = MqlUtil.mqlCommand(context, cmd, fromName+"_PRJ");
					if (fromName.equals(result)) { 
						DomainAccess.deleteObjectOwnership(context, toId, "", fromName+"_PRJ", COMMENT_MULTIPLE_OWNERSHIP_FOLLOWER, false);
					}
				}	
			}
			StringList reportedAgainstObjects = DomainAccess.getReportedAgainstObject(context, toId);
			for(Object objectAsReportedAgainst : reportedAgainstObjects){
				...
				try {
					ContextUtil.pushContext(context, null, null, null);
					DomainAccess.deleteObjectOwnership(context, connectedID, "", fromName+"_PRJ", commentForType , true);
				}finally{
					ContextUtil.popContext(context);
				}
			}
...
public MapList getIssuesForWidgets(Context context, String[] args)
	throws Exception{
		Map programMap = (Map) JPO.unpackArgs(args);
		StringList busSelects = (StringList) programMap.get("JPO_BUS_SELECTS");
		
		MapList retMapList = new MapList();
		MapList tempIssueMapList = new MapList();
		String typePattern =PropertyUtil.getSchemaProperty(context, Issue.SYMBOLIC_type_Issue);
	   ...
	   //Forming the where expression
	   //((owner == context.user ) || (originator == context.user) || (to[Assigned Issue].from.name == context.user) || (attribute[Co-Owners].value ~~ *context.user*)) AND (current != 'Closed')
	   sbOwnerCondition.append(SYMB_OPEN_PARAN).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_OWNER).append(SYMB_EQUAL).append(SYMB_QUOTE).append(strOwner).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN).append(SYMB_OR).append(SYMB_OPEN_PARAN).append(DomainConstants.SELECT_ORIGINATOR).append(SYMB_EQUAL).append(SYMB_QUOTE).append(strOwner).append(SYMB_QUOTE).append(SYMB_CLOSE_PARAN).append(SYMB_OR);
       ...
       String whereExpression = sbOwnerCondition.toString();
	   
	   tempIssueMapList = getIssueDetails(context, busSelects, typePattern, whereExpression);
	   for(int i=0; i<tempIssueMapList.size(); i++){
        	retMapList.add((Map)tempIssueMapList.get(i));
       }
	   return retMapList;
	}
	
	private MapList getIssueDetails(Context context, StringList busSelects, String typePattern, String whereExpression)
	throws Exception{
	...
	@com.matrixone.apps.framework.ui.ProgramCallable
    public  String getPersonConnectedToCompany(Context context, String[] args ) throws Exception
    {
        try
        {   
			HashMap paramMap = (HashMap)JPO.unpackArgs(args);
            String objectId = (String)paramMap.get("objectId");
            String strRelationship = PropertyUtil.getSchemaProperty("relationship_Division");
            String mqlCmd = "print bus $1 select $2 $3 dump $4";     
            String mqlOutPut = MqlUtil.mqlCommand(context, mqlCmd, objectId,"to[Division].from.name","name","|");
            StringList mqlOutPutSplit= FrameworkUtil.split(mqlOutPut, "|");
            return "TYPES=type_Person:CURRENT=policy_Person.state_Active:member="+(String)mqlOutPutSplit.get(0)+":member!="+(String)mqlOutPutSplit.get(1);
        }
        catch (Exception ex)
        {
			ex.printStackTrace();
	...
	/**
	 * Method to check for display of deprecated attributes under mql expression ISU_PROPERTIES.
	 *
	 * @param context - the eMatrix <code>Context</code> object
	 * @param args - args contains a Map with the following entries
	 *                      objectId - The object Id of Context object
	 ...
	 * @since R424 FD01
	 */
	public boolean bDeprecatedAttributeDisplay(Context context, String[] args) throws Exception {
			boolean bFlag=false;
			String mqlVariable = "ISU_PROPERTIES";
			String command = "print expression $1 select value dump";
			String result = "false";
			try{
					result = MqlUtil.mqlCommand(context, command, mqlVariable).trim();
        ...
        public boolean bIssueCategoryOrIssueClassification(Context context, String[] args) throws Exception {
                boolean bFlag=false;
                try {
                        if(bDeprecatedAttributeDisplay(context,args)){
                                bFlag = showIssueCategoryOrIssueClassificationField(context,args);
                        }else{
                                bFlag = false;
                        }
                } catch (Exception e) {
        ...
        public boolean bTxtWaitOnDate(Context context, String[] args) throws Exception {
                boolean bFlag=false;
                try {
                        if(bDeprecatedAttributeDisplay(context,args)){
                                bFlag = bDateDisplay(context,args);
                        }else{
                                bFlag = false;
                        }
                } catch (Exception e) {
        ...
        public boolean bWaitOnDate(Context context, String[] args) throws Exception {
                boolean bFlag=false;
                try {
                        if(bDeprecatedAttributeDisplay(context,args)){
                                bFlag = bDateNotDisplay(context, args);
                        }else{
                                bFlag = false;
                        }
                } catch (Exception e) {
		 ...
		 * @since R426
		 */
		public Object getPolicies(Context context, String[] args) throws Exception {
			// Issue Type
       	    String strType = PropertyUtil.getSchemaProperty(context, Issue.SYMBOLIC_type_Issue);
			
			// Get Issue policies
            MapList policies = mxType.getPolicies(context, strType, false);
			
			// Get actual name of Issue Template policy
			String strIssueTemplatePolicy = PropertyUtil.getSchemaProperty(context, "policy_IssueTemplate");
			
            StringList policyList = new StringList();
            for(int i=0; i<policies.size(); i++) {
                Map policyMap = (Map) policies.get(i);
				
				// policy name
				String policy = (String)policyMap.get(DomainConstants.SELECT_NAME);
				
				// do not add Issue Template policy in the list
				if(!policy.equals(strIssueTemplatePolicy)){
	   ...
	   public int updatePolicy(Context context, String[] args) {
			return 0;
	   }
}
