...
public class emxSchemaManifestBase_mxJPO
{
        ...
        throws Exception
    {
        ...
        String sStatusFileDir_Container = emxInstallUtil_mxJPO.executeMQLCommand(context, "get env MXAPPBUILDFORCONTAINER");
		String sTempPath = System.getenv("X3D_TMP_DIR_INSTALL");

		if (UIUtil.isNotNullAndNotEmpty(sStatusFileDir_Container)  && sStatusFileDir_Container.length()>0) {
			sStatusFileDir = sTempPath + File.separator + sStatusFileDir_Container;
		}
