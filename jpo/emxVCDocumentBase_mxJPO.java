     ...
     public HashMap connect(Context context, HashMap uploadParamsMap) throws Exception {
        try {
                ...
                VCDocument.OBJECT_ACTION_CONVERT_CHECKIN_VC_FILE_FOLDER))
            {
                ...
                String strCommand = "disconnect bus $1 $2";
                if ("TRUE".equalsIgnoreCase(vcfile)) {
                	MqlUtil.mqlCommand(context, strCommand, true, objectId, "vcfile");
                } else if ("TRUE".equalsIgnoreCase(vcfolder)) {
                	MqlUtil.mqlCommand(context, strCommand, true, objectId, "vcfolder");
                } else if ("TRUE".equalsIgnoreCase(vcmodule)) {
                	MqlUtil.mqlCommand(context, strCommand, true, objectId, "vcmodule");
                }
            }
        ...
        try {
...

            {
                ...
                if (objectAction.equalsIgnoreCase(VCDocument.OBJECT_ACTION_CONNECT_VC_ON_DEMAND)) {
                    ...
                    if (relVaultedObjects.equals(parentRelName)) {
             ...
             /* StringBuffer disBuff = new StringBuffer(250);
              ...
              if("TRUE".equalsIgnoreCase(vcfile))
               ...
               if ("TRUE".equalsIgnoreCase(vcfile)) {
               	...
               	MqlUtil.mqlCommand(context, strCommand, objectId, "vcfile");
               } else if ("TRUE".equalsIgnoreCase(vcfolder)) {
                   //MqlUtil.mqlCommand(context, "disconnect bus " +objectId+ " vcfolder", true);
               	MqlUtil.mqlCommand(context, strCommand, objectId, "vcfolder");
               } else if ("TRUE".equalsIgnoreCase(vcmodule)) {
                   //MqlUtil.mqlCommand(context, "disconnect bus " +objectId+ " vcmodule", true);
               	MqlUtil.mqlCommand(context, strCommand, objectId, "vcmodule");
               }
        ...
        try {
            ...
            if (hasRealValue(parentId)) {
                ...
                if (!"".equals(store)) {
                    ...
                    String strCommand = "print store $1 select $2 $3 $4 $5 dump $6";
                    String storeData = MqlUtil.mqlCommand(context, strCommand, store, "protocol", "host", "port", "path", "|");
    ...
    public Object updateSelector(Context context, String[] args) throws Exception {
        try {
            ...
            if (!newSelector.equals(oldSelector)) {
                ...
                String strCmd = "modify bus $1 $2 $3 $4";
                if (isVCFolder) {
                	MqlUtil.mqlCommand(context, strCmd, objectId, "vcconnection", "config", newSelector );
                }   
                else {
                	MqlUtil.mqlCommand(context, strCmd, objectId, "vcconnection", "selector", newSelector );
                }
            }
