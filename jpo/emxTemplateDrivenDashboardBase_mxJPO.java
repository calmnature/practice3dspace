...
public class emxTemplateDrivenDashboardBase_mxJPO
{
     ...
     * @since PMC 10-6
     */
    public MapList getDashboards(Context context, String[] args) throws Exception {
      ...
      throws Exception
    {
        ...
        {
            //ex.printStackTrace(); 
            DebugUtil.debug("getDescription "+ ex.getMessage());
            throw ex;
      ...
      throws Exception
    {
        ...
        {
            //ex.printStackTrace();  
            DebugUtil.debug("getCount "+ ex.getMessage());
            throw ex;           
        }       
         return vecCount;       
    }
     ...
     */
    public static Object getAllProjectTemplates(Context context, String[] args ) throws Exception {
        ...
        {     
            ...
            ${CLASS:emxProjectTemplate} base      = new ${CLASS:emxProjectTemplate}(context, null);
     ...
     * @throws Exception java.lang.Exception
     */
    public Vector getDashboardName(Context context, String[] args) throws Exception {
    	return new Vector();
    	/*HashMap programMap          = (HashMap) JPO.unpackArgs(args);
    	Map paramList               = (Map) programMap.get("paramList");
    	String strSuiteDir          = (String) paramList.get("SuiteDirectory");
    ...
    */    
     ...
     * @throws Exception
     */
    private int[] getThresholdValues(Context context) throws Exception {       
        /*int slipValue1=0;
        int slipValue2=0;
        int riskValue1=0;
        int riskValue2=0;
    ...
    public MapList getRelatedProjects(Context context, String[] args) throws Exception {
    	MapList returnList          = new MapList(); 
    	/*try{
    		//Added for : Context user has preference currency or not
    		${CLASS:emxProgramCentralUtilBase}.getUserPreferenceCurrency(context, "emxProjectBudget.Error.NoDefaultCurrencyDefined");
    		...
    		while (listItr.hasNext())
    		{
    			...
    			MapList projectRisks = risk.getProjectAllRisks(context, projectSpace, "current != Complete");
    			...
    			${CLASS:emxFinancialItem} financial = new ${CLASS:emxFinancialItem}(context, args);
    			if (! mlBudget.isEmpty()){
    				...
    				projectMap.put("totalCost", ${CLASS:emxProgramCentralUtilBase}.getFormattedCurrencyValue (context, null, preferredCurrency,totalcost));
    			}
    			else {
    			...
    			if (! mlBenefit.isEmpty()){
    				...
    				projectMap.put("totalBenefit", ${CLASS:emxProgramCentralUtilBase}.getFormattedCurrencyValue (context, null, preferredCurrency,totalbenift));
    			}
    			else {
    ...
    public matrix.db.Set getSet( Context context, String getName )
    {
      ...
      {
        //me.printStackTrace(); 
        DebugUtil.debug("getSet "+ me.getMessage());
        return null;
      }
      return null;
    }
    ...
    */
    ...
    {        
    	...
    	for (int i = 0; i < objectList.size(); i++)
    	{
    		...
    		if(bCSVReportFromat){
    			totalCostList.add(XSSUtil.encodeForXML(context,totalCost));
    		}
    		else{
    			sbOutput.append("<a href=\"javascript:showModalDialog('" + (String) relBusObjMap.get("financeURL1"));
    			sbOutput.append("', '600', '600')\"  class='object'>");
    			sbOutput.append("<b>"+XSSUtil.encodeForXML(context,(String) relBusObjMap.get("totalCost"))+"</b></a>");                    
    ...
    try{
        ...
        dOffset = iRawOffset/3600000D ;
		 ...
		 DebugUtil.debug(" inside getTimezone "+ e.getMessage());
		//System.out.println(" exception in getTimezone method in MBOMutil "+e);
        dOffset = 0.0;
    }
    return dOffset;
     ...
     * @throws Exception java.lang.Exception
     */
    public StringList getNewWindowForDashboard(Context context, String[] args) throws Exception {        
       /* HashMap programMap          = (HashMap) JPO.unpackArgs(args);
        Map paramList               = (Map) programMap.get("paramList");
        MapList relBusObjPageList   = (MapList) programMap.get("objectList");
...
//      System.out.println("---setValues--->"+setValues);
     ...
     */
        public static MapList getWBSDynamicColumns(Context context, String[] args) throws Exception {
        	...
        	if(selectedTemplateId!=null && !"null".equals(selectedTemplateId) && !defaultTempValue.equals(selectedTemplateId) )
        	{
        		...
        		{          
					...
					Object oName = taskMapForTemplate.get(DomainConstants.SELECT_NAME);
					templateWBSTasksList.add(String.valueOf(oName));
						...
						oName = taskMapForTemplate.get(DomainConstants.SELECT_NAME);
						templateWBSTasksList.add(String.valueOf(oName));                           
        				}
        			}
        		}
         ...
         * @throws Exception java.lang.Exception
         */
        public StringList getColumnValues(Context context, String[] args) throws Exception {
         ...
         * @throws Exception
         */
        public String getTaskColorStatus(Context context, Map objectMap) throws Exception {
