    ...
    public Vector getLockIcon(Context context, String[] args) throws Exception
    {
        ...
        try
        {
            ...
            for(int i=0; i< objectList.size(); i++)
            {
                ...
                fileLocker = UIRTEUtil.htmlEncode(context, fileLocker);
                ...
                if ("TRUE".equalsIgnoreCase(fileLocked)){
                    ...
                    statusImageString = "<img border=\"0\" src=\"../common/images/iconStatusLocked.gif\" alt=\"" + fileLocker + "\" title=\"" +titleText+" : "+ fileLocker + "\"/>";
                }
                showLock.add(statusImageString);
            }
            return  showLock;
