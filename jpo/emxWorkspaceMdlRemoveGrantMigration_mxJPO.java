...
public class emxWorkspaceMdlRemoveGrantMigration_mxJPO extends emxCommonMigration_mxJPO
{
    ...
    public static void init(Context context) throws Exception
    {
        ...
        mxObjectSelects.add("type");
        mxObjectSelects.add("name");
        mxObjectSelects.add("revision");
        mxObjectSelects.add("grant.granteeaccess");
        mxObjectSelects.add("ownership");
		mxObjectSelects.add(contentId);
		mxObjectSelects.add(contentIdRev2);
		mxObjectSelects.add(SELECT_ATTRIBUTE_ACCESS_TYPE);
		mulValSelects.add("grant.granteeaccess");
		...
		String command = "get env $1";

		String result = MqlUtil.mqlCommand(context, command, true, "MIGRATE_TEAM_OBJECTS_CONTENT_SEPARATELY");
