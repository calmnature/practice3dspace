...
public class emxWeeklyTimesheetNotificationBase_mxJPO extends emxSpool_mxJPO
{
    ...
    throws MatrixException {
        ...
        try {
            ...
            // RVW: IR-1371250 - Only send notification if preference is set to yes
            //
            if(shouldSendNotificationForSubTimesheet(context, strTimesheetOwner)){
    ...
    throws MatrixException {
        ...
        try {
            ...
            for (Iterator itr = mlApprover.iterator(); itr.hasNext();) {
                ...
                // RVW: IR-1371250 - Only add person to list if preference is set to yes
                //
                if(shouldSendNotificationForSubTimesheet(context, strApp)){
                    strApp = strApp + "|" + "Both";
 ...
 private com.matrixone.jdom.Document getTimesheetSubmittedMailXML(Context context, String strSubmittedBy, String strSubmittedOn, Map info) throws MatrixException
 {
     try{
         ...
         if(ODT_TEST_CASE.equalsIgnoreCase(invokeFromODTFile)) {
                baseURL = (String) CacheUtil.getCacheObject(context, "baseURL");
     }
...
protected boolean shouldSendNotificationForSubTimesheet(Context context, String strTo) throws MatrixException
{
    ...
    String sResult = MqlUtil.mqlCommand(context, sCommandStatement, strTo, "active", "property[preference_SubmittedTimesheetNotificationOn].value");
...
protected boolean shouldSendNotificationForRejTimesheet(Context context, String strTo) throws MatrixException
{
    ...
    ContextUtil.pushContext(context,strTo,DomainConstants.EMPTY_STRING, DomainConstants.EMPTY_STRING);
