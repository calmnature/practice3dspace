 ...
 *
 * Copyright (c) 1992-2020 Dassault Systemes. All Rights
   ...
   throws Exception {
       ...
       for(int i = 0; i < objList.size(); i++) {
           ...
           if("0".equalsIgnoreCase(level)){
               ...
               memberAccessList.add(Boolean.toString(bool));
           } else {
               memberAccessList.add(Boolean.toString(hasEditAccess));
           }
       }
   ...
   throws Exception {
       ...
       while (memberListItr.hasNext()) {
           ...
           if ("Person".equals(filterValue)) {
               memberList.add((String)map.get("PERSON_ID"));
           } else {
               memberList.add((String)map.get("name"));
           }
       }
       return memberList;
   }
