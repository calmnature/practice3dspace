...
public final class Process_ExchangeXPDM_XPDM2_MBOMWithoutProcess_mxJPO extends CompletionJPOEvaluator {
	...
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_2__BOM_ExchangeXPDM_With = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("BOM_ExchangeXPDM_WithEBOMScoped");
	private final static com.dassault_systemes.EKLEngine.common.lib.implementation.StringType _STRING_3__SBOM_ExchangeXPDM_XPD = new com.dassault_systemes.EKLEngine.common.lib.implementation.StringType("SBOM_ExchangeXPDM_XPDM2");
	...
	public final void evaluate(matrix.db.Context iContext, com.dassault_systemes.EKLEngine.common.lib.PLMIDSet iPLMIDSet, com.dassault_systemes.EKLEngine.common.lib.PLMIDSet oPLMIDSet)	
		...
		PLMIDSetProductScope.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMProcedure( iContext , _STRING_2__BOM_ExchangeXPDM_With, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { iPLMIDSet } ) );
		PLMIDSetSBOMSpecific.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMProcedure( iContext , _STRING_3__SBOM_ExchangeXPDM_XPD, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { iPLMIDSet } ) );
		oPLMIDSet.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( iPLMIDSet, PLMIDSetCommonPatterns ), PLMIDSetSBOMSpecific ), PLMIDSetProductScope ), PLMIDSetProductIL ) );
	}
}
